...
Managed instances load their resolved `config.json`, its imported layers, and defaults. Foreground deployments can override that configuration with environment variables.
