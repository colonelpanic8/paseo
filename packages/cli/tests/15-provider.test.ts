...
try {
  ...
  // Test 12: provider add creates a custom profile that provider rm removes
  {
    console.log("Test 12: provider add creates a custom profile that provider rm removes");
  ...
  // Test 13: provider add and rm refuse built-in provider ids
  {
    console.log("Test 13: provider add and rm refuse built-in provider ids");
