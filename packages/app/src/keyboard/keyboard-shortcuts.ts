...
const SHORTCUT_BINDINGS: readonly ShortcutBinding[] = [
  ...
  {
    id: "workspace-isolation-pick-cmd-shift-i-mac",
    action: "workspace.isolation.pick",
    combo: "Cmd+Shift+I",
    when: { mac: true, commandCenter: false },
    help: {
      id: "select-workspace-isolation",
      section: "projects",
      label: "Select workspace isolation",
      keys: ["mod", "shift", "I"],
    },
  },
  {
    id: "workspace-isolation-pick-ctrl-shift-i-non-mac",
    action: "workspace.isolation.pick",
    combo: "Ctrl+Shift+I",
    when: { mac: false, commandCenter: false, terminal: false },
    help: {
  ...
  {
    id: "workspace-ref-pick-cmd-shift-b-mac",
  ...
  {
    id: "workspace-ref-pick-ctrl-shift-b-non-mac",
    action: "workspace.ref.pick",
    combo: "Ctrl+Shift+B",
    when: { mac: false, commandCenter: false, terminal: false },
    help: {
  ...
  {
    id: "workspace-host-pick-cmd-shift-h-mac",
  ...
  {
    id: "workspace-host-pick-ctrl-shift-h-non-mac",
    action: "workspace.host.pick",
    combo: "Ctrl+Shift+H",
    when: { mac: false, commandCenter: false, terminal: false },
    help: {
  ...
  {
    id: "message-input-model-pick-ctrl-shift-m-non-mac",
    action: "message-input.model.pick",
    combo: "Ctrl+Shift+M",
    when: { mac: false, commandCenter: false, terminal: false },
    help: {
  ...
  {
    id: "message-input-thinking-pick-cmd-shift-e-mac",
  ...
  {
    id: "message-input-thinking-pick-ctrl-shift-e-non-mac",
    action: "message-input.thinking.pick",
    combo: "Ctrl+Shift+E",
    when: { mac: false, commandCenter: false, terminal: false },
    help: {
  ...
  {
    id: "message-input-mode-pick-cmd-shift-a-mac",
  ...
  {
    id: "message-input-mode-pick-ctrl-shift-a-non-mac",
    action: "message-input.mode.pick",
    combo: "Ctrl+Shift+A",
    when: { mac: false, commandCenter: false, terminal: false },
    help: {
  ...
  {
    id: "message-input-fast-mode-toggle-cmd-alt-f-mac",
  ...
  {
    id: "message-input-fast-mode-toggle-ctrl-alt-f-non-mac",
    action: "message-input.fast-mode.toggle",
    combo: "Ctrl+Alt+F",
    repeat: false,
    when: { mac: false, commandCenter: false, terminal: false },
