    ...
    ({ item }: { item: ModelBrowserListItem }) => {
      ...
      return (
        <SelectableModelRow
          ...
          onSelect={onSelect}
          profiledRows={profiledLookup.get(`${item.row.provider}:${item.row.modelId}`) ?? []}
          onCreateProfile={onCreateProfile}
          onEditProfile={onEditProfile}
          onEditProfiles={onEditProfiles}
        />
