...
const EMPTY_AGENT_PANEL_DESCRIPTOR_STATE = {
  ...
  attentionReason: null,
  isTurnActive: false,
  ...pickAgentModelDisplaySource(null),
};
...
function useAgentPanelDescriptor(
  ...
  const hasPurposeSummary = Boolean(descriptorState.summary);

  return {
    label: label ?? "",
    subtitle: hasPurposeSummary ? purposePresentation.subtitle : subtitle,
    tooltip: hasPurposeSummary ? purposePresentation.tooltip : label ?? subtitle,
