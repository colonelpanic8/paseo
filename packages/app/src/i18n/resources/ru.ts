...
export const ru: TranslationResources = {
  ...
  settings: {
    ...
    usageHistory: {
      incompleteCosts:
        "Для части активности цена неизвестна. Стоимость и столбцы учитывают только активность с известной ценой; ≥ означает нижнюю границу, а — неизвестную стоимость.",
      ...
      coverage: {
        ...
        duplicates: "Учтено один раз: {{sources}}",
      },
      metric: {
        cost: "Стоимость",
        tokens: "Токены",
