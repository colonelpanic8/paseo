  ...
  settings: {
    ...
    providers: {
      ...
      accounts: {
        ...
        updateHost: "Обновите хост, чтобы управлять учётными записями провайдеров.",
        addClaudeTitle: "Добавить учётную запись Claude",
        addClaude: "Учётная запись Claude Code",
        addClaudeDescription: "Использовать отдельный каталог конфигурации Claude",
        addCodexTitle: "Добавить учётную запись Codex",
        addCodex: "Учётная запись Codex / ChatGPT",
        addCodexDescription: "Использовать отдельный каталог Codex и вход",
        add: "Добавить",
        name: "Название учётной записи",
        namePlaceholder: "например, Работа",
        claudeDirectory: "Каталог конфигурации Claude",
        claudeDirectoryPlaceholder: "/home/you/.claude-work",
        claudeDirectoryHint: "Укажите этот абсолютный путь хоста в CLAUDE_CONFIG_DIR.",
        codexDirectory: "Домашний каталог Codex",
        codexDirectoryPlaceholder: "/home/you/.codex-work",
        codexDirectoryHint: "Укажите этот абсолютный путь хоста в CODEX_HOME.",
        errors: {
