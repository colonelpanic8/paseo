  ...
  workspace: {
    ...
    tabs: {
      ...
      toasts: {
        ...
        snoozingAgent: "Откладываем агента...",
        snoozedAgent: "Агент отложен",
        failedToSnoozeAgent: "Не удалось отложить агента",
        wakingAgent: "Пробуждаем агента...",
        wokeAgent: "Агент пробуждён",
        failedToWakeAgent: "Не удалось разбудить агента",
      },
      confirmations: {
