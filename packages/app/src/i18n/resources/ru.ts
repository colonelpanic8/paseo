...
export const ru: TranslationResources = {
  ...
  settings: {
    ...
    usageHistory: {
      ...
      info: "Итоги по токенам и стоимости, прочитанные из журналов сессий CLI провайдеров на этом хосте. Стоимость — оценка по тарифам API, а не счёт.",
      refresh: "Обновить",
      unsupported: "Обновите хост, чтобы увидеть историю использования",
      hostUnavailable: "Подключитесь к этому хосту, чтобы увидеть историю использования",
