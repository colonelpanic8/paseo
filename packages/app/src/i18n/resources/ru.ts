...
export const ru: TranslationResources = {
  ...
  workspacePruning: {
    title: "Очистить отсутствующие рабочие пространства",
    description:
      "Архивировать рабочие пространства, папки которых больше не существуют на {{host}}. История агентов сохраняется.",
    scanning: "Проверка папок рабочих пространств…",
    archiving: "Архивация отсутствующих рабочих пространств…",
    missing: "Отсутствующие рабочие пространства: {{count}}",
    archived: "Архивированные рабочие пространства: {{count}}",
    archive: "Архивировать отсутствующие рабочие пространства",
    partialFailure: "Не удалось проверить или архивировать некоторые рабочие пространства.",
    updateHost: "Обновите этот хост, чтобы очистить отсутствующие рабочие пространства.",
  },
  newWorkspace: {
