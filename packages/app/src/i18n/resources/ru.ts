  ...
  sidebar: {
    ...
    workspace: {
      ...
      toasts: {
        ...
        wakingWorkspace: "Рабочее пространство пробуждается…",
        wokeWorkspace: "Рабочее пространство разбужено",
        failedToWakeWorkspace: "Не удалось разбудить рабочее пространство",
