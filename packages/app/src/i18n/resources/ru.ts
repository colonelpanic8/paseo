  ...
  sidebar: {
    ...
    workspace: {
      ...
      toasts: {
        ...
        hostDisconnected: "Host не подключен",
        snoozingWorkspace: "Откладываем рабочую область...",
        snoozedWorkspace: "Рабочая область отложена",
        failedToSnoozeWorkspace: "Не удалось отложить рабочую область",
        wakingWorkspace: "Пробуждаем рабочую область...",
