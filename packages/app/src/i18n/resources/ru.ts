...
export const ru: TranslationResources = {
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        retitle: "Переименовать с помощью ИИ",
        pin: "Закрепить вверху",
        unpin: "Открепить",
        snooze: "Отложить",
        snoozeHour: "Отложить на 1 час",
        snoozeEvening: "Отложить до вечера",
        snoozeTomorrow: "Отложить до завтра",
        snoozeNextWeek: "Отложить до следующей недели",
        snoozeCustom: "Выбрать время…",
        wake: "Разбудить",
        snoozedUntil: "Отложено до {{time}} ({{duration}})",
      ...
      customSnooze: {
        ...
        date: "Дата",
        time: "Время",
        pastTime: "Выберите время в будущем.",
        confirm: "Отложить",
      },
      toasts: {
        ...
        snoozingWorkspace: "Рабочее пространство откладывается…",
        snoozedWorkspace: "Рабочее пространство отложено",
        failedToSnoozeWorkspace: "Не удалось отложить рабочее пространство",
        wakingWorkspace: "Рабочее пространство возобновляется…",
        wokeWorkspace: "Рабочее пространство возобновлено",
        failedToWakeWorkspace: "Не удалось возобновить рабочее пространство",
        hostDisconnected: "Хост не подключён",
        retitlingWorkspace: "Создаётся новое название…",
        retitledWorkspace: "Рабочее пространство переименовано",
        failedToRetitleWorkspace: "Не удалось переименовать рабочее пространство",
  ...
  liveVoice: {
    ...
    settings: {
      ...
      quickLaunch: {
        ...
        auto: "Автоматически",
        profileLabel: "Профиль ярлыка",
        profileHint:
          "Какой профиль отвечает на звонок по ярлыку на этом хосте. Тот же выбор, что и в меню живого голоса.",
        hostDefault: "По умолчанию хоста",
      },
      dispatch: {
  ...
  voiceProfiles: {
    menu: {
      ...
      defaultProfile: "По умолчанию хоста",
      threadLabel: "Тред",
      newThread: "Новый тред",
      manage: "Управлять профилями…",
    },
    thread: {
      untitled: "Тред без названия",
    },
    settings: {
      title: "Профили и треды",
      description:
        "Профиль задаёт поведение звонка: инструкции, контекст, файлы, голос и модель действий. Тред — это то, что звонок запоминает. Каждый звонок открывает или продолжает тред под выбранным профилем.",
      manage: "Управлять",
    },
    manage: {
      title: "Профили и треды",
      noHosts: "Ни один подключённый хост не поддерживает профили. Обновите его демон.",
      profiles: "Профили",
      profilesEmpty: "Профилей пока нет. Звонки используют настройки хоста по умолчанию.",
      threads: "Треды",
      threadsEmpty: "Тредов пока нет. Каждый звонок на этом хосте начинает новый.",
      selectedForCalls: "Используется для новых звонков",
      continuing: "Продолжится в следующем звонке",
      hostDefault: "По умолчанию хоста",
      fromConfig: "Из config.json демона",
      noInstructions: "Без инструкций",
      entries: "Записей: {{n}}",
    },
    actions: {
      ...
      stopUsing: "Использовать значение хоста",
      continueThread: "Продолжить в следующем звонке",
      stopContinuing: "Начать заново в следующем звонке",
      openHistory: "Открыть историю",
      edit: "Изменить",
      delete: "Удалить",
      deleteProfileTitle: "Удалить {{name}}?",
      deleteProfileMessage:
        "Треды, которые его использовали, сохранят историю и продолжат без его настроек.",
      deleteThreadTitle: "Удалить {{title}}?",
      deleteThreadMessage:
        "История разговора и сводка будут удалены. Работа, делегированная агентам, продолжится.",
    },
    form: {
      ...
      instructions: {
        ...
        placeholder: "Передавайте работу агентам; никогда не пишите код сами.",
      },
      context: {
        label: "Контекст",
        hint: "{{length}} / {{max}}. Фоновая информация, известная звонку с самого начала.",
        placeholder: "Мы выпускаем голосовой проект. Предпочитайте репозиторий paseo.",
      },
      files: {
        label: "Файлы контекста",
        hint: "{{count}} / {{max}}. По одному абсолютному пути или пути от ~ на строку; демон читает их при старте звонка.",
      ...
      backendModel: {
        label: "Модель действий",
        hint: "Выполняет действия звонка в фоне; это не говорящая модель.",
        default: "По умолчанию (быстрая)",
      },
      backendThinking: {
        label: "Размышление модели действий",
        hint: "Глубина рассуждений модели действий.",
        default: "По умолчанию",
      },
      errors: {
        ...
        filesInvalid: "Каждый файл должен быть абсолютным путём или путём от ~, не более 16",
      },
    },
    history: {
      title: "История",
      ...
      summary: {
        label: "Сводка",
        hint: "Пишете вы. Новые звонки читают её вместо старой истории.",
        coversThrough: "Охватывает историю до записи №{{seq}}.",
        placeholder: "Что следующий звонок должен помнить.",
  ...
  settings: {
    ...
    usageHistory: {
      sort: {
        ...
        remove: "Удалить",
        timeHint: "Недели начинаются в понедельник. Итоги включают только выбранный период.",
      },
      ...
      info: "Итоги по токенам и стоимости, прочитанные из журналов сессий CLI провайдеров на каждом подключённом хосте. Стоимость — оценка по тарифам API, а не счёт.",
      refresh: "Обновить",
      unsupported: "Обновите хост, чтобы увидеть историю использования",
      hostUnavailable: "Подключитесь к хосту, чтобы увидеть историю использования",
      clientUnavailable: "Подключение к хосту не готово",
      errorTitle: "Не удалось загрузить историю использования",
      empty: "Нет активности за этот период",
      pricingUnavailable: "Стоимость недоступна, пока не загрузятся цены моделей",
      addHost: "Добавьте хост, чтобы увидеть историю использования",
      hostsUnavailable: "Ни один выбранный хост не может сообщить историю использования",
      hostFilter: {
        label: "Хосты",
        all: "Все хосты",
        count_one: "{{count}} хост",
        count_other: "{{count}} хостов",
      },
      coverage: {
        scanning: "Сканирование {{hosts}}…",
        offline_one: "{{hosts}} не в сети",
        offline_other: "{{hosts}} не в сети",
        unsupported_one: "{{hosts}} работает на старой версии Paseo и исключён",
        unsupported_other: "{{hosts}} работают на старой версии Paseo и исключены",
        failed_one: "Не удалось прочитать журналы сессий на {{hosts}}",
        failed_other: "Не удалось прочитать журналы сессий на {{hosts}}",
        duplicates: "Учтено один раз: {{groups}}",
        duplicateGroup_one: "{{hosts}} читает те же расшифровки, что и {{claimedBy}}",
        duplicateGroup_other: "{{hosts}} читают те же расшифровки, что и {{claimedBy}}",
      },
      metric: {
        cost: "Стоимость",
        tokens: "Токены",
      ...
      totals: {
        title: "Итоги",
        processedTokens: "Обработанные токены",
        cachedInput: "Ввод из кэша",
        uncachedInput: "Ввод без кэша",
        output: "Вывод",
    ...
    general: {
      ...
      assistantAutomation: {
        label: "Разрешить EVA запускать агентов",
        description:
          "Разрешить ассистенту EVA запускать агентов и отправлять им запросы без подтверждения, даже на заблокированном телефоне",
      },
      language: {
        label: "Язык",
    ...
    host: {
      ...
      daemon: {
        ...
        color: {
          section: "Внешний вид",
          title: "Цвет",
          hint: "Окрашивает метку этого хоста на боковой панели",
          options: {
            none: "Нет",
            blue: "Синий",
            green: "Зелёный",
