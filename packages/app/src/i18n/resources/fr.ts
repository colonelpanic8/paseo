...
export const fr: TranslationResources = {
  ...
  settings: {
    ...
    providers: {
      ...
      accounts: {
        title: "Comptes",
        updateHost: "Mettez à jour l’hôte pour gérer les comptes fournisseurs.",
        addClaudeTitle: "Ajouter un compte Claude",
        addClaude: "Compte Claude Code",
        addClaudeDescription: "Utiliser un répertoire de configuration Claude distinct",
        addCodexTitle: "Ajouter un compte Codex",
        addCodex: "Compte Codex / ChatGPT",
        addCodexDescription: "Utiliser un répertoire Codex et une connexion distincts",
        add: "Ajouter le compte",
        name: "Nom du compte",
        namePlaceholder: "p. ex. Travail",
        claudeDirectory: "Répertoire de configuration Claude",
        claudeDirectoryPlaceholder: "/home/you/.claude-work",
        claudeDirectoryHint: "Définissez CLAUDE_CONFIG_DIR sur ce chemin absolu de l’hôte.",
        codexDirectory: "Répertoire d’accueil Codex",
        codexDirectoryPlaceholder: "/home/you/.codex-work",
        codexDirectoryHint: "Définissez CODEX_HOME sur ce chemin absolu de l’hôte.",
        errors: {
