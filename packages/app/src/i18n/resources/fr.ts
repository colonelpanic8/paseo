  ...
  workspace: {
    ...
    tabs: {
      ...
      toasts: {
        ...
        snoozingAgent: "Mise en veille de l'agent...",
        snoozedAgent: "Agent mis en veille",
        failedToSnoozeAgent: "Échec de la mise en veille de l'agent",
        wakingAgent: "Réveil de l'agent...",
        wokeAgent: "Agent réveillé",
        failedToWakeAgent: "Échec du réveil de l'agent",
      },
      confirmations: {
