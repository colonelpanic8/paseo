...
export const fr: TranslationResources = {
  ...
  composer: {
    ...
    stash: {
      ...
      stashedEvicted: "Prompt mis de côté — le plus ancien a été supprimé pour faire de la place",
      restored: "Prompt restauré",
      undo: "Annuler",
      badgeAccessibilityLabel: "Prompts mis de côté : {{count}}. Ouvrir la réserve.",
      menuTitle: "Prompts mis de côté",
      menuEmpty: "Rien de mis de côté pour l'instant",
      attachmentsOnly_one: "{{count}} pièce jointe",
      attachmentsOnly_other: "{{count}} pièces jointes",
      deleteEntry: "Supprimer le prompt mis de côté",
      otherProviders_one: "{{count}} prompt mis de côté sous un autre fournisseur",
      otherProviders_other: "{{count}} prompts mis de côté sous d'autres fournisseurs",
    },
    errors: {
  ...
  message: {
    ...
    actions: {
      ...
      forkFullHistory: "Historique complet",
      forkFullHistoryUnavailable: "Ce fournisseur ne peut pas dériver sa session.",
      forkSummary: "Résumé",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        retitle: "Renommer avec l'IA",
        pin: "Épingler en haut",
        unpin: "Désépingler",
        snooze: "Mettre en veille",
        snoozeHour: "Reporter d'une heure",
        snoozeEvening: "Reporter jusqu'à ce soir",
        snoozeTomorrow: "Reporter jusqu'à demain",
        snoozeNextWeek: "Reporter jusqu'à la semaine prochaine",
        snoozeCustom: "Reporter jusqu'à une heure personnalisée…",
        wake: "Réveiller",
        snoozedUntil: "Reporté jusqu'à {{time}} ({{duration}})",
      ...
      customSnooze: {
        title: "Report personnalisé",
        until: "Reporter jusqu'au",
        date: "Date",
        time: "Heure",
        pastTime: "Choisissez une heure future.",
        confirm: "Reporter",
      },
      toasts: {
        ...
        hostDisconnected: "Hostn'est pas connecté",
        snoozingWorkspace: "Mise en veille de l'espace de travail...",
        snoozedWorkspace: "Espace de travail mis en veille",
        failedToSnoozeWorkspace: "Échec de la mise en veille de l'espace de travail",
        wakingWorkspace: "Réveil de l'espace de travail...",
        wokeWorkspace: "Espace de travail réveillé",
        failedToWakeWorkspace: "Échec du réveil de l'espace de travail",
        retitlingWorkspace: "Génération d'un nouveau titre...",
        retitledWorkspace: "Espace de travail renommé",
        failedToRetitleWorkspace: "Impossible de renommer l'espace de travail",
  ...
  liveVoice: {
    ...
    settings: {
      ...
      quickLaunch: {
        ...
        auto: "Automatique",
        profileLabel: "Profil du raccourci",
        profileHint:
          "Le profil qui répond à un appel par raccourci sur cet hôte. Même sélection que dans le menu Voix en direct.",
  ...
  voiceProfiles: {
    menu: {
      profileLabel: "Profil",
      defaultProfile: "Défaut de l'hôte",
      threadLabel: "Fil",
      newThread: "Nouveau fil",
      manage: "Gérer les profils…",
    },
    thread: {
      untitled: "Fil sans titre",
    },
    settings: {
      title: "Profils et fils",
      description:
        "Un profil définit le comportement d'un appel : instructions, contexte, fichiers, voix et modèle d'action. Un fil est ce qu'un appel retient. Chaque appel ouvre ou poursuit un fil sous le profil choisi.",
      manage: "Gérer",
    },
    manage: {
      title: "Profils et fils",
      noHosts: "Aucun hôte connecté ne prend en charge les profils. Mettez son daemon à jour.",
      profiles: "Profils",
      profilesEmpty:
        "Pas encore de profil. Les appels utilisent les réglages par défaut de l'hôte.",
      threads: "Fils",
      threadsEmpty: "Pas encore de fil. Chaque appel sur cet hôte en démarre un.",
      selectedForCalls: "Utilisé pour les nouveaux appels",
      continuing: "Poursuivi par le prochain appel",
      hostDefault: "Défaut de l'hôte",
      fromConfig: "Depuis le config.json du daemon",
    ...
    actions: {
      ...
      stopUsing: "Utiliser le défaut de l'hôte",
      continueThread: "Poursuivre au prochain appel",
      stopContinuing: "Repartir de zéro au prochain appel",
      openHistory: "Ouvrir l'historique",
      edit: "Modifier",
      delete: "Supprimer",
      deleteProfileTitle: "Supprimer {{name}} ?",
      deleteProfileMessage:
        "Les fils qui l'utilisaient gardent leur historique et continuent sans sa configuration.",
      deleteThreadTitle: "Supprimer {{title}} ?",
      deleteThreadMessage:
    ...
    form: {
      ...
      instructions: {
        ...
        placeholder: "Confiez le travail aux agents ; n'écrivez jamais de code vous-même.",
      },
      context: {
        label: "Contexte",
        hint: "{{length}} / {{max}}. Contexte connu de l'appel dès le début.",
        placeholder: "Nous livrons le projet vocal. Privilégiez le dépôt paseo.",
      },
      files: {
        label: "Fichiers de contexte",
        hint: "{{count}} / {{max}}. Un chemin absolu ou commençant par ~ par ligne ; le daemon les lit au début de l'appel.",
      ...
      backendModel: {
        label: "Modèle d'action",
        hint: "Exécute les actions de l'appel en arrière-plan ; ce n'est pas le modèle qui parle.",
        default: "Par défaut (rapide)",
      },
      backendThinking: {
        label: "Réflexion d'action",
        hint: "Profondeur de raisonnement du modèle d'action.",
        default: "Par défaut",
      },
      errors: {
        nameRequired: "Le nom est requis",
        ...
        tooLong: "Trop long",
        filesInvalid:
          "Chaque fichier doit être un chemin absolu ou commençant par ~, 16 au maximum",
      },
    },
    history: {
      title: "Historique",
      ...
      delegationFailed: "Délégation échouée ({{code}}) : {{description}}",
      user: "Vous",
      assistant: "Assistant",
      limits:
        "Les nouveaux appels partent du résumé plus l'historique récent qui tient dans la limite de contexte du fournisseur. La parole en direct n'est pas reprise.",
      summary: {
        label: "Résumé",
        hint: "Rédigé par vous. Les nouveaux appels le lisent à la place de l'historique ancien.",
        coversThrough: "Couvre l'historique jusqu'à l'entrée n°{{seq}}.",
        placeholder: "Ce que le prochain appel doit retenir.",
        willCover: "L'enregistrement couvre l'historique jusqu'à l'entrée n°{{seq}}.",
  ...
  contextWindow: {
    ...
    promptCache: {
      ...
      statusExpired: "Probablement expiré",
      statusUnknown: "Durée inconnue",
      warmFor: "chaud pendant ~{{duration}}",
      expiredAgo: "expiré il y a {{duration}}",
      lastRequestAgo: "dernière requête il y a {{duration}}",
      durationSeconds: "{{value}} s",
      durationMinutes: "{{value}} min",
      lastRequest: "Dernière requête {{percent}}% en cache · {{split}}",
      split: "{{cached}} en cache, {{fresh}} nouveaux",
      splitWithWrite: "{{cached}} en cache, {{fresh}} nouveaux, {{written}} écrits",
      sessionSingular: "Session {{percent}}% en cache sur {{count}} requête",
      sessionPlural: "Session {{percent}}% en cache sur {{count}} requêtes",
      ping: "Réchauffer",
      pinging: "Réchauffement...",
      pingHint: "Envoie un court message pour garder le cache chaud",
      pingError: "Impossible d'envoyer le message",
    },
  },
  review: {
    comment: {
  ...
  settings: {
    ...
    usageHistory: {
      ...
      refresh: "Actualiser",
      unsupported: "Mettez l'hôte à jour pour voir l'historique d'utilisation",
      hostUnavailable: "Connectez-vous à un hôte pour voir l'historique d'utilisation",
      clientUnavailable: "La connexion à l'hôte n'est pas prête",
      errorTitle: "Impossible de charger l'historique d'utilisation",
      empty: "Aucune activité sur cette période",
      pricingUnavailable:
        "Les coûts sont indisponibles tant que les tarifs des modèles ne sont pas chargés",
      addHost: "Ajoutez un hôte pour voir l'historique d'utilisation",
      hostsUnavailable: "Aucun hôte sélectionné ne peut fournir l'historique d'utilisation",
      hostFilter: {
        label: "Hôtes",
        all: "Tous les hôtes",
        count_one: "{{count}} hôte",
        count_other: "{{count}} hôtes",
      },
      coverage: {
        scanning: "Analyse de {{hosts}}…",
        offline_one: "{{hosts}} est hors ligne",
        offline_other: "{{hosts}} sont hors ligne",
        unsupported_one: "{{hosts}} exécute une version plus ancienne de Paseo et est exclu",
      ...
      totals: {
        title: "Totaux",
        processedTokens: "Jetons traités",
        cachedInput: "Entrée en cache",
        uncachedInput: "Entrée hors cache",
        output: "Sortie",
    ...
    shortcuts: {
      ...
      help: {
        ...
        stashPrompt: "Mettre le prompt de côté",
        interruptAgent: "Agent d'interruption",
        sendMessage: "Envoyer un message",
        queueMessage: "Message de file d'attente",
