...
export const ja: TranslationResources = {
  ...
  settings: {
    ...
    providers: {
      ...
      accounts: {
        title: "アカウント",
        updateHost: "プロバイダーアカウントを管理するにはホストを更新してください。",
        addClaudeTitle: "Claude アカウントを追加",
        addClaude: "Claude Code アカウント",
        addClaudeDescription: "別の Claude 設定ディレクトリを使用します",
        addCodexTitle: "Codex アカウントを追加",
        addCodex: "Codex / ChatGPT アカウント",
        addCodexDescription: "別の Codex ホームとサインインを使用します",
        add: "アカウントを追加",
        name: "アカウント名",
        namePlaceholder: "例：仕事用",
        claudeDirectory: "Claude 設定ディレクトリ",
        claudeDirectoryPlaceholder: "/home/you/.claude-work",
        claudeDirectoryHint: "CLAUDE_CONFIG_DIR をホスト上のこの絶対パスに設定します。",
        codexDirectory: "Codex ホームディレクトリ",
        codexDirectoryPlaceholder: "/home/you/.codex-work",
        codexDirectoryHint: "CODEX_HOME をホスト上のこの絶対パスに設定します。",
        errors: {
