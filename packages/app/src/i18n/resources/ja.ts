  ...
  workspace: {
    ...
    tabs: {
      ...
      toasts: {
        ...
        snoozingAgent: "エージェントをスヌーズ中...",
        snoozedAgent: "エージェントをスヌーズしました",
        failedToSnoozeAgent: "エージェントのスヌーズに失敗しました",
        wakingAgent: "エージェントを起こしています...",
        wokeAgent: "エージェントを起こしました",
        failedToWakeAgent: "エージェントを起こせませんでした",
      },
      confirmations: {
        unsavedTitle: "未保存の変更",
