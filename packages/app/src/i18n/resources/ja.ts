...
export const ja: TranslationResources = {
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        retitle: "AIでタイトルを付け直す",
        pin: "上部に固定",
        unpin: "固定解除",
        snooze: "スヌーズ",
        snoozeHour: "1時間スヌーズ",
        snoozeEvening: "今晩までスヌーズ",
        snoozeTomorrow: "明日までスヌーズ",
        snoozeNextWeek: "来週までスヌーズ",
        snoozeCustom: "日時を指定してスヌーズ…",
        wake: "スヌーズ解除",
        snoozedUntil: "{{time}} までスヌーズ中（あと{{duration}}）",
        snoozedChip: "{{time}}・あと{{duration}}",
        archive: "アーカイブ",
      ...
      toasts: {
        ...
        hostDisconnected: "ホストが接続されていません",
        snoozingWorkspace: "ワークスペースをスヌーズ中...",
        snoozedWorkspace: "ワークスペースをスヌーズしました",
        failedToSnoozeWorkspace: "ワークスペースのスヌーズに失敗しました",
        wakingWorkspace: "ワークスペースを起こしています...",
        wokeWorkspace: "ワークスペースを起こしました",
        failedToWakeWorkspace: "ワークスペースを起こせませんでした",
        retitlingWorkspace: "新しいタイトルを生成中...",
        retitledWorkspace: "ワークスペースのタイトルを更新しました",
        failedToRetitleWorkspace: "ワークスペースのタイトルを更新できませんでした",
  ...
  liveVoice: {
    ...
    settings: {
      ...
      quickLaunch: {
        ...
        auto: "自動",
        profileLabel: "ショートカットのプロファイル",
        profileHint:
          "そのホストでショートカット通話に応答するプロファイル。ライブ音声メニューと同じ選択です。",
        hostDefault: "ホストのデフォルト",
      },
      dispatch: {
  ...
  voiceProfiles: {
    ...
    settings: {
      title: "プロファイルとスレッド",
      description:
        "プロファイルは通話の振る舞い（指示、コンテキスト、ファイル、音声、アクションモデル）を定めます。スレッドは通話が記憶する内容です。各通話は選択したプロファイルのもとでスレッドを開くか続けます。",
      manage: "管理",
    },
    manage: {
      title: "プロファイルとスレッド",
      noHosts: "プロファイルに対応する接続済みホストがありません。デーモンを更新してください。",
      profiles: "プロファイル",
      profilesEmpty: "まだプロファイルがありません。通話はホストのデフォルト設定を使います。",
      threads: "スレッド",
      threadsEmpty: "まだスレッドがありません。このホストでの各通話がスレッドを開始します。",
      selectedForCalls: "新しい通話で使用",
      continuing: "次の通話で続行",
      hostDefault: "ホストのデフォルト",
      fromConfig: "デーモンの config.json から",
      noInstructions: "指示なし",
      entries: "{{n}} 件",
    },
    actions: {
      ...
      menu: "{{name}} の操作",
      useForCalls: "通話で使用",
      stopUsing: "ホストのデフォルトを使用",
      continueThread: "次の通話で続行",
      stopContinuing: "次の通話は新規に開始",
      openHistory: "履歴を開く",
      edit: "編集",
      delete: "削除",
      deleteProfileTitle: "{{name}} を削除しますか？",
      deleteProfileMessage: "使用していたスレッドは履歴を保持し、この設定なしで続行します。",
      deleteThreadTitle: "{{title}} を削除しますか？",
      deleteThreadMessage:
    ...
    form: {
      ...
      name: {
        label: "名前",
        placeholder: "チーフオブスタッフ",
      },
      instructions: {
        label: "指示",
        hint: "{{length}} / {{max}}。毎回の通話で音声エージェントにそのまま渡されます。",
        placeholder: "作業はエージェントに任せ、自分ではコードを書かないでください。",
      },
      context: {
        label: "コンテキスト",
        hint: "{{length}} / {{max}}。通話が最初から把握している背景情報です。",
        placeholder: "音声プロジェクトをリリース中です。paseo リポジトリを優先してください。",
      },
      files: {
        label: "コンテキストファイル",
        hint: "{{count}} / {{max}}。1 行につき絶対パスまたは ~ から始まるパスを 1 つ。デーモンが通話開始時に読み込みます。",
      ...
      backendModel: {
        label: "アクションモデル",
        hint: "通話のアクションを裏で実行します。発話するモデルではありません。",
        default: "デフォルト（高速）",
      },
      backendThinking: {
        label: "アクションの思考",
      ...
      errors: {
        ...
        tooLong: "長すぎます",
        filesInvalid: "各ファイルは絶対パスまたは ~ から始まるパスで、最大 16 件です",
      },
    },
    history: {
      title: "履歴",
      ...
      delegationOk: "委任済み: {{description}}",
      delegationFailed: "委任失敗 ({{code}}): {{description}}",
      user: "あなた",
      assistant: "アシスタント",
      limits:
        "新しい通話は要約と、プロバイダーのコンテキスト上限に収まる直近の履歴から始まります。ライブの発話は再開されません。",
      summary: {
        label: "要約",
        hint: "あなたが書きます。新しい通話は古い履歴の代わりにこれを読みます。",
        coversThrough: "エントリ #{{seq}} までの履歴を対象にします。",
        placeholder: "次の通話に引き継ぐ内容。",
        willCover: "保存するとエントリ #{{seq}} までの履歴が対象になります。",
        save: "要約を保存",
      },
    },
  },
  ...
  settings: {
    ...
    usageHistory: {
      sort: {
        ...
        moveUp: "上へ",
        remove: "削除",
        timeHint: "週は月曜日から始まります。合計には選択した期間のみが含まれます。",
      },
      ...
      refresh: "更新",
      unsupported: "使用履歴を表示するにはホストを更新してください",
      hostUnavailable: "使用履歴を表示するにはホストに接続してください",
      clientUnavailable: "ホストへの接続が準備できていません",
      errorTitle: "使用履歴を読み込めません",
      empty: "この期間のアクティビティはありません",
      pricingUnavailable: "モデル価格が読み込まれるまでコストは利用できません",
      addHost: "使用履歴を表示するにはホストを追加してください",
      hostsUnavailable: "選択したどのホストも使用履歴を報告できません",
      hostFilter: {
        label: "ホスト",
        all: "すべてのホスト",
        count_one: "{{count}} ホスト",
        count_other: "{{count}} ホスト",
      },
      coverage: {
        scanning: "{{hosts}} をスキャン中…",
        offline_one: "{{hosts}} はオフラインです",
        offline_other: "{{hosts}} はオフラインです",
        unsupported_one: "{{hosts}} は古い Paseo を実行しているため除外されました",
      ...
      totals: {
        title: "合計",
        processedTokens: "処理トークン",
        cachedInput: "キャッシュ入力",
        uncachedInput: "非キャッシュ入力",
        output: "出力",
