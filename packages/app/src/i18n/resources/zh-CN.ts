...
export const zhCN: TranslationResources = {
  ...
  settings: {
    ...
    providers: {
      ...
      accounts: {
        title: "账户",
        updateHost: "请更新 Host 以管理 Provider 账户。",
        addClaudeTitle: "添加 Claude 账户",
        addClaude: "Claude Code 账户",
        addClaudeDescription: "使用单独的 Claude 配置目录",
        addCodexTitle: "添加 Codex 账户",
        addCodex: "Codex / ChatGPT 账户",
        addCodexDescription: "使用单独的 Codex 主目录和登录",
        add: "添加账户",
        name: "账户名称",
        namePlaceholder: "例如：工作",
        claudeDirectory: "Claude 配置目录",
        claudeDirectoryPlaceholder: "/home/you/.claude-work",
        claudeDirectoryHint: "将 CLAUDE_CONFIG_DIR 设为此主机上的绝对路径。",
        codexDirectory: "Codex 主目录",
        codexDirectoryPlaceholder: "/home/you/.codex-work",
        codexDirectoryHint: "将 CODEX_HOME 设为此主机上的绝对路径。",
        errors: {
