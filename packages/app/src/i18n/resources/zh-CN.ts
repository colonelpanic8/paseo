...
export const zhCN: TranslationResources = {
  ...
  composer: {
    ...
    stash: {
      stashed: "提示词已暂存",
      stashedEvicted: "提示词已暂存 — 已删除最旧的暂存以腾出空间",
      restored: "已恢复暂存的提示词",
      undo: "撤销",
      badgeAccessibilityLabel: "已暂存提示词:{{count}}。打开暂存。",
      menuTitle: "已暂存的提示词",
      menuEmpty: "还没有暂存任何内容",
      attachmentsOnly_one: "{{count}} 个附件",
      attachmentsOnly_other: "{{count}} 个附件",
      deleteEntry: "删除暂存的提示词",
      otherProviders_one: "另有 {{count}} 条提示词暂存于其他提供商",
      otherProviders_other: "另有 {{count}} 条提示词暂存于其他提供商",
    },
    errors: {
      failedToSend: "发送消息失败",
  ...
  message: {
    ...
    actions: {
      ...
      forkFullHistory: "完整历史",
      forkFullHistoryUnavailable: "此提供程序无法分支其会话。",
      forkSummary: "摘要",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        snoozeHour: "暂停 1 小时",
        snoozeEvening: "暂停到今晚",
        snoozeTomorrow: "暂停到明天",
        snoozeNextWeek: "暂停到下周",
        snoozeCustom: "暂停到自定义时间…",
        wake: "唤醒",
        snoozedUntil: "已暂停到 {{time}}（剩余 {{duration}}）",
        snoozedChip: "{{time}}・剩余 {{duration}}",
        archive: "归档",
      ...
      toasts: {
        ...
        hostDisconnected: "Host 未连接",
        snoozingWorkspace: "正在暂停 workspace...",
        snoozedWorkspace: "workspace 已暂停",
        failedToSnoozeWorkspace: "暂停 workspace 失败",
        wakingWorkspace: "正在唤醒 workspace...",
        wokeWorkspace: "workspace 已唤醒",
        failedToWakeWorkspace: "唤醒 workspace 失败",
        retitlingWorkspace: "正在生成新标题...",
        retitledWorkspace: "已重新命名 workspace",
        failedToRetitleWorkspace: "重新命名 workspace 失败",
  ...
  dispatch: {
    ...
    cancel: "取消",
    dismiss: "关闭",
    defaultTarget: "你的 Dispatch 智能体",
    errors: {
      noTarget: "请先在设置中选择 Dispatch 智能体。",
      hostOffline: "Dispatch 智能体所在的主机已离线。",
      nothingHeard: "没有听到任何内容。",
      sendFailed: "无法联系你的 Dispatch 智能体。",
    },
  },
  liveVoice: {
    label: "实时语音",
    ...
    settings: {
      ...
      dispatch: {
        ...
        description: "选择接收手表或 paseo://dispatch 快捷方式一次性提示的主机。",
        chooseHost: "选择主机",
        noHosts: "没有可用主机",
        agentLabel: "Dispatch 智能体",
        agentHint: "来自手表或快捷方式的语音提示会发送给此智能体。",
        notSet: "未设置",
        clear: "未设置",
        noAgents: "此主机上没有智能体",
      },
  ...
  voiceProfiles: {
    ...
    settings: {
      title: "配置与会话",
      description:
        "配置决定通话的行为：指令、上下文、文件、语音和执行模型。会话是通话所记住的内容。每次通话都会在所选配置下打开或继续一个会话。",
      manage: "管理",
    },
    manage: {
      title: "配置与会话",
      noHosts: "没有已连接的主机支持配置。请更新其守护进程。",
      profiles: "配置",
      profilesEmpty: "还没有配置。通话将使用主机的默认设置。",
      threads: "会话",
      threadsEmpty: "还没有会话。此主机上的每次通话都会开始一个。",
      selectedForCalls: "用于新通话",
      continuing: "下次通话将继续",
      hostDefault: "主机默认",
      fromConfig: "来自守护进程的 config.json",
      noInstructions: "无指令",
      entries: "{{n}} 条记录",
    },
    actions: {
      ...
      useForCalls: "用于通话",
      stopUsing: "使用主机默认",
      continueThread: "下次通话继续",
      stopContinuing: "下次通话重新开始",
      openHistory: "打开历史",
      edit: "编辑",
      delete: "删除",
      deleteProfileTitle: "删除 {{name}}？",
      deleteProfileMessage: "使用它的会话会保留历史记录，并在没有该配置的情况下继续。",
      deleteThreadTitle: "删除 {{title}}？",
      deleteThreadMessage: "其对话历史和摘要将被删除。已委派给智能体的工作会继续运行。",
    },
    form: {
      createTitle: "新建配置",
      editTitle: "编辑配置",
      ...
      instructions: {
        label: "指令",
        hint: "{{length}} / {{max}}。每次通话都会原样传给语音智能体。",
        placeholder: "把工作交给智能体；不要自己写代码。",
      },
      context: {
        label: "上下文",
        hint: "{{length}} / {{max}}。通话从一开始就掌握的背景信息。",
        placeholder: "我们正在发布语音项目。优先使用 paseo 仓库。",
      },
      files: {
        label: "上下文文件",
        hint: "{{count}} / {{max}}。每行一个绝对路径或以 ~ 开头的路径；守护进程在通话开始时读取。",
      ...
      errors: {
        ...
        nameTooLong: "名称过长",
        tooLong: "过长",
        filesInvalid: "每个文件必须是绝对路径或以 ~ 开头的路径，最多 16 个",
      },
    },
    history: {
      title: "历史",
      ...
      loadOlder: "加载更早的",
      callStarted: "通话开始",
      callEnded: "通话结束 · {{cause}}",
      delegationOk: "已委派：{{description}}",
      delegationFailed: "委派失败（{{code}}）：{{description}}",
      user: "你",
      assistant: "助手",
      limits: "新通话从摘要和符合提供商上下文限制的最近历史开始。实时语音不会恢复。",
      summary: {
        label: "摘要",
        hint: "由你撰写。新通话会读取它来代替更早的历史。",
        coversThrough: "涵盖到第 #{{seq}} 条记录的历史。",
        placeholder: "下次通话应带上的内容。",
        willCover: "保存后将涵盖到第 #{{seq}} 条记录的历史。",
        save: "保存摘要",
      },
    },
  },
  ...
  contextWindow: {
    ...
    promptCache: {
      ...
      statusExpired: "可能已过期",
      statusUnknown: "有效期未知",
      warmFor: "剩余约 {{duration}}",
      expiredAgo: "已过期 {{duration}}",
      lastRequestAgo: "上次请求在 {{duration}} 前",
      durationSeconds: "{{value}} 秒",
      durationMinutes: "{{value}} 分钟",
      lastRequest: "上次请求 {{percent}}% 命中缓存 · {{split}}",
      split: "缓存 {{cached}}，新增 {{fresh}}",
      splitWithWrite: "缓存 {{cached}}，新增 {{fresh}}，写入 {{written}}",
      sessionSingular: "会话 {{percent}}% 命中缓存，共 {{count}} 次请求",
      sessionPlural: "会话 {{percent}}% 命中缓存，共 {{count}} 次请求",
      ping: "预热",
      pinging: "预热中...",
      pingHint: "发送一条简短消息以保持缓存有效",
      pingError: "无法发送消息",
    },
  },
  review: {
  ...
  settings: {
    ...
    usageHistory: {
      ...
      refresh: "刷新",
      unsupported: "更新主机后可查看使用历史",
      hostUnavailable: "连接主机后可查看使用历史",
      clientUnavailable: "主机连接尚未就绪",
      errorTitle: "无法加载使用历史",
      empty: "此时间范围内没有活动",
      pricingUnavailable: "模型价格加载完成前无法显示费用",
      addHost: "添加主机后可查看使用历史",
      hostsUnavailable: "所选主机都无法报告使用历史",
      hostFilter: {
        label: "主机",
        all: "全部主机",
        count_one: "{{count}} 个主机",
        count_other: "{{count}} 个主机",
      },
      coverage: {
        scanning: "正在扫描 {{hosts}}…",
        offline_one: "{{hosts}} 已离线",
        offline_other: "{{hosts}} 已离线",
        unsupported_one: "{{hosts}} 运行的 Paseo 版本过旧，已排除",
    ...
    shortcuts: {
      ...
      help: {
        ...
        nextReadyWaitingWorkspace: "下一个就绪或等待中的 workspace",
        previousTab: "上一个标签",
        nextTab: "下一个标签",
        ...
        switchProject: "切换项目",
        toggleWorkspaceIsolation: "切换工作区隔离",
        selectHost: "选择主机",
    ...
    host: {
      ...
      agentEnvironment: {
        sectionTitle: "代理环境",
        sectionDescription: "在代理启动前于其目录中运行命令，其输出将成为代理的环境。",
        add: "添加环境设置",
        addCustom: "自定义命令…",
        addCustomTitle: "添加环境命令",
        editCommand: "编辑命令",
        editCommandTitle: "编辑环境命令",
        remove: "移除",
        removeConfirmTitle: "移除环境设置？",
        removeConfirmMessage: "移除“{{name}}”？",
        moveUp: "上移",
        moveDown: "下移",
        emptyState: "代理启动前不会运行任何内容。请添加 direnv 或自定义命令。",
        unknownPreset: "此主机无法识别此预设",
        rowFormat: "读取 {{format}} 输出",
        commandLabel: "命令",
        commandHint: "以空格分隔。如需 shell 请显式运行。",
        commandPlaceholder: "direnv export json",
        commandRequired: "命令为必填项",
        formatLabel: "输出格式",
        formatJson: "JSON 差异",
        formatEnv0: "env -0",
        formatJsonHint: "形如“KEY”：“value”的对象，null 表示删除该变量。",
        formatEnv0Hint: "以 NUL 分隔的 KEY=VALUE 记录。未包含的均被删除。",
        timeoutLabel: "超时",
        timeoutHint: "放弃命令前的毫秒数。留空则使用主机默认值。",
        timeoutPlaceholder: "30000",
        timeoutInvalid: "超时必须为正整数",
        saving: "保存中...",
        save: "保存",
      },
      terminalProfiles: {
