...
export const zhCN: TranslationResources = {
  ...
  assistants: {
    ...
    settings: {
      title: "助手",
      description:
        "有名字的语音助手，拥有各自的指令、声音、操作模型和记住的对话。在实时语音菜单中选中的助手会取代下方的通话设置。",
      manage: "管理",
    },
    manage: {
      title: "助手",
      noHosts: "没有已连接的主机支持助手。请更新其守护进程。",
      assistants: "助手",
      empty: "还没有助手。创建一个，让通话拥有名字和记忆。",
      templates: "模板",
      templatesEmpty: "没有模板。将助手保存为模板即可复用其配置。",
      selectedForCalls: "用于实时语音通话",
      fromTemplate: "来自 {{name}}",
      entries: "{{n}} 条历史记录",
    },
    actions: {
      newAssistant: "新建助手",
      ...
      newFromTemplate: "从模板新建助手",
      delete: "删除",
      deleteAssistantTitle: "删除 {{name}}？",
      deleteAssistantMessage: "将删除其对话历史和摘要。已委派给代理的工作会继续运行。",
      deleteTemplateTitle: "删除模板 {{name}}？",
      deleteTemplateMessage: "由它创建的助手会保留各自的配置副本。",
    },
    form: {
      createAssistantTitle: "新建助手",
      ...
      startFrom: {
        label: "起始模板",
        hint: "复制模板的配置。之后的修改只属于这个助手。",
        none: "空白",
        empty: "没有模板",
      },
      instructions: {
        label: "指令",
        hint: "{{length}} / {{max}}。每次通话都会原样传给语音代理。",
        placeholder: "把工作交给代理；自己绝不写代码。",
      },
      context: {
        label: "上下文",
        hint: "{{length}} / {{max}}。助手在每次通话开始时就知道的背景信息。",
    ...
    history: {
      ...
      user: "你",
      assistant: "助手",
      limits: "新通话从摘要以及能放入提供方上下文限制的最近历史开始。实时语音不会恢复。",
      summary: {
        label: "摘要",
        hint: "由你撰写。新通话会读取它来代替更早的历史。",
        coversThrough: "涵盖到第 {{seq}} 条历史。",
        placeholder: "助手应该带到下次的内容。",
        willCover: "保存后将涵盖到第 {{seq}} 条历史。",
        save: "保存摘要",
      },
    },
  },
