...
export const ar: TranslationResources = {
  ...
  settings: {
    ...
    usageHistory: {
      ...
      title: "سجل الاستخدام",
      info: "إجماليات الرموز والتكلفة المقروءة من سجلات جلسات أدوات المزوّدين على هذا المضيف. التكاليف تقديرات معادلة لأسعار API وليست فاتورة.",
      refresh: "تحديث",
      unsupported: "حدّث المضيف لعرض سجل الاستخدام",
      hostUnavailable: "اتصل بهذا المضيف لعرض سجل الاستخدام",
