  ...
  workspace: {
    ...
    tabs: {
      ...
      toasts: {
        ...
        snoozingAgent: "جارٍ وضع الوكيل في غفوة...",
        snoozedAgent: "تم تأجيل الوكيل",
        failedToSnoozeAgent: "تعذر تأجيل الوكيل",
        wakingAgent: "جارٍ إيقاظ الوكيل...",
        wokeAgent: "تم إيقاظ الوكيل",
        failedToWakeAgent: "تعذر إيقاظ الوكيل",
      },
      confirmations: {
