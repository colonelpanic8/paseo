...
export const ar: TranslationResources = {
  ...
  settings: {
    ...
    providers: {
      ...
      accounts: {
        title: "الحسابات",
        updateHost: "حدّث المضيف لإدارة حسابات المزوّدين.",
        addClaudeTitle: "إضافة حساب Claude",
        addClaude: "حساب Claude Code",
        addClaudeDescription: "استخدم مجلد إعدادات Claude منفصلاً",
        addCodexTitle: "إضافة حساب Codex",
        addCodex: "حساب Codex / ChatGPT",
        addCodexDescription: "استخدم مجلد Codex منفصلاً وتسجيل دخول ChatGPT أو API",
        add: "إضافة حساب",
        name: "اسم الحساب",
        namePlaceholder: "مثلاً: العمل",
        claudeDirectory: "مجلد إعدادات Claude",
        claudeDirectoryPlaceholder: "/home/you/.claude-work",
        claudeDirectoryHint: "عيّن CLAUDE_CONFIG_DIR إلى هذا المسار المطلق على المضيف.",
        codexDirectory: "مجلد Codex الرئيسي",
        codexDirectoryPlaceholder: "/home/you/.codex-work",
        codexDirectoryHint: "عيّن CODEX_HOME إلى هذا المسار المطلق على المضيف.",
        errors: {
