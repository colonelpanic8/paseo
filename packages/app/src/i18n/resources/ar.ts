...
export const ar: TranslationResources = {
  ...
  assistants: {
    menu: {
      label: "المساعد",
      none: "بدون مساعد",
      manage: "إدارة المساعدين…",
    },
    settings: {
      title: "المساعدون",
      description:
        "مساعدون صوتيون مسمّون، لكل منهم تعليماته وصوته ونموذج الإجراءات ومحادثته المحفوظة. المساعد المختار في قائمة الصوت المباشر يحل محل إعدادات المكالمة أدناه.",
      manage: "إدارة",
    },
    manage: {
      title: "المساعدون",
      noHosts: "لا يوجد مضيف متصل يدعم المساعدين. حدّث خدمته.",
      assistants: "المساعدون",
      empty: "لا يوجد مساعدون بعد. أنشئ واحدًا لتمنح المكالمات اسمًا وذاكرة.",
      templates: "القوالب",
      templatesEmpty: "لا توجد قوالب. احفظ مساعدًا كقالب لإعادة استخدام إعداداته.",
      selectedForCalls: "مستخدم لمكالمات الصوت المباشر",
      fromTemplate: "من {{name}}",
      entries: "{{n}} مدخلات في السجل",
    },
    actions: {
      ...
      stopUsing: "إيقاف الاستخدام للمكالمات",
      openHistory: "فتح السجل",
      edit: "تعديل",
      saveAsTemplate: "حفظ كقالب",
      newFromTemplate: "مساعد جديد من القالب",
      delete: "حذف",
      deleteAssistantTitle: "حذف {{name}}؟",
      deleteAssistantMessage: "سيُحذف سجل محادثته وملخصه. العمل الذي فوّضه إلى الوكلاء يستمر.",
      deleteTemplateTitle: "حذف القالب {{name}}؟",
      deleteTemplateMessage: "المساعدون المنشأون منه يحتفظون بنسختهم الخاصة من الإعدادات.",
    },
    form: {
      createAssistantTitle: "مساعد جديد",
      ...
      name: {
        label: "الاسم",
        placeholder: "مدير المكتب",
      },
      startFrom: {
        label: "البدء من",
        hint: "ينسخ إعدادات القالب. التعديلات اللاحقة تبقى لهذا المساعد.",
        none: "فارغ",
        empty: "لا توجد قوالب",
      },
      instructions: {
        label: "التعليمات",
        hint: "{{length}} / {{max}}. تُمرَّر إلى وكيل الصوت كما هي في كل مكالمة.",
        placeholder: "وجّه العمل إلى الوكلاء؛ لا تكتب الكود بنفسك أبدًا.",
      },
      context: {
        label: "السياق",
        hint: "{{length}} / {{max}}. خلفية دائمة يعرفها المساعد في بداية كل مكالمة.",
        placeholder: "نعمل على إطلاق مشروع الصوت. فضّل مستودع paseo.",
      },
      voice: {
        label: "الصوت",
      ...
      backendModel: {
        label: "نموذج الإجراءات",
        hint: "ينفّذ إجراءات المساعد في الخلفية؛ وهو ليس النموذج المتكلّم.",
        default: "الافتراضي (سريع)",
      },
      backendThinking: {
        label: "تفكير الإجراءات",
    ...
    history: {
      title: "السجل",
      empty: "لم يُحفظ شيء بعد. ابدأ مكالمة للبدء.",
      ...
      assistant: "المساعد",
      limits:
        "تبدأ المكالمات الجديدة من الملخص إضافة إلى أحدث سجل يتسع في حد سياق المزوّد. لا يُستأنف الكلام المباشر.",
      summary: {
        label: "الملخص",
        hint: "تكتبه أنت. تقرأه المكالمات الجديدة بدلًا من السجل الأقدم.",
        coversThrough: "يغطي السجل حتى المدخل رقم {{seq}}.",
        placeholder: "ما ينبغي أن يحمله المساعد معه.",
        willCover: "الحفظ يغطي السجل حتى المدخل رقم {{seq}}.",
        save: "حفظ الملخص",
      },
    },
  },
