...
export const ar: TranslationResources = {
  ...
  workspacePruning: {
    title: "تنظيف مساحات العمل المفقودة",
    description: "أرشفة مساحات العمل التي لم تعد مجلداتها موجودة على {{host}}. يُحتفظ بسجل الوكلاء.",
    scanning: "جارٍ التحقق من مجلدات مساحات العمل…",
    archiving: "جارٍ أرشفة مساحات العمل المفقودة…",
    missing: "مساحات العمل المفقودة: {{count}}",
    archived: "مساحات العمل المؤرشفة: {{count}}",
    archive: "أرشفة مساحات العمل المفقودة",
    partialFailure: "تعذّر التحقق من بعض مساحات العمل أو أرشفتها.",
    updateHost: "حدّث هذا المضيف لتنظيف مساحات العمل المفقودة.",
  },
  newWorkspace: {
