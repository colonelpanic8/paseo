...
export const ar: TranslationResources = {
  ...
  composer: {
    ...
    stash: {
      stashed: "تم تخزين الموجّه",
      stashedEvicted: "تم تخزين الموجّه — حُذف الأقدم لإفساح المجال",
      restored: "تمت استعادة الموجّه المخزّن",
      undo: "تراجع",
      badgeAccessibilityLabel: "الموجّهات المخزّنة: {{count}}. افتح المخزن.",
      menuTitle: "الموجّهات المخزّنة",
      menuEmpty: "لا يوجد شيء مخزّن بعد",
      attachmentsOnly_one: "{{count}} مرفق",
      attachmentsOnly_other: "{{count}} مرفقات",
      deleteEntry: "حذف الموجّه المخزّن",
      otherProviders_one: "{{count}} موجّه مخزّن لدى مزوّد آخر",
      otherProviders_other: "{{count}} موجّهات مخزّنة لدى مزوّدين آخرين",
    },
    errors: {
  ...
  message: {
    ...
    actions: {
      ...
      forkFullHistory: "السجل الكامل",
      forkFullHistoryUnavailable: "لا يمكن لهذا المزود تفريع الجلسة.",
      forkSummary: "ملخص",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        retitle: "إعادة التسمية بالذكاء الاصطناعي",
        pin: "تثبيت في الأعلى",
        unpin: "إلغاء التثبيت",
        snooze: "تأجيل",
        snoozeHour: "غفوة لمدة ساعة",
        snoozeEvening: "غفوة حتى هذا المساء",
        snoozeTomorrow: "غفوة حتى الغد",
        snoozeNextWeek: "غفوة حتى الأسبوع القادم",
        snoozeCustom: "غفوة حتى وقت مخصص…",
        wake: "إيقاظ",
        snoozedUntil: "في غفوة حتى {{time}} ({{duration}})",
      ...
      customSnooze: {
        ...
        date: "التاريخ",
        time: "الوقت",
        pastTime: "اختر وقتًا في المستقبل.",
        confirm: "غفوة",
      },
      toasts: {
        ...
        hostDisconnected: "Host غير متصل",
        snoozingWorkspace: "جارٍ تأجيل مساحة العمل...",
        snoozedWorkspace: "تم تأجيل مساحة العمل",
        failedToSnoozeWorkspace: "تعذر تأجيل مساحة العمل",
        wakingWorkspace: "جارٍ إيقاظ مساحة العمل...",
        wokeWorkspace: "تم إيقاظ مساحة العمل",
        failedToWakeWorkspace: "تعذر إيقاظ مساحة العمل",
        retitlingWorkspace: "جارٍ إنشاء عنوان جديد...",
        retitledWorkspace: "تمت إعادة تسمية مساحة العمل",
        failedToRetitleWorkspace: "تعذّرت إعادة تسمية مساحة العمل",
  ...
  liveVoice: {
    ...
    settings: {
      ...
      quickLaunch: {
        ...
        auto: "تلقائي",
        profileLabel: "ملف الاختصار الشخصي",
        profileHint:
          "الملف الشخصي الذي يرد على مكالمة الاختصار على ذلك المضيف. الاختيار نفسه كما في قائمة الصوت المباشر.",
        hostDefault: "افتراضي المضيف",
      },
      dispatch: {
  ...
  voiceProfiles: {
    menu: {
      ...
      defaultProfile: "افتراضي المضيف",
      threadLabel: "السلسلة",
      newThread: "سلسلة جديدة",
      manage: "إدارة الملفات الشخصية…",
    },
    thread: {
      untitled: "سلسلة بلا عنوان",
    },
    settings: {
      title: "الملفات الشخصية والسلاسل",
      description:
        "يحدد الملف الشخصي سلوك المكالمة: التعليمات والسياق والملفات والصوت ونموذج الإجراءات. السلسلة هي ما تتذكره المكالمة. تفتح كل مكالمة سلسلة أو تكملها ضمن الملف الشخصي المختار.",
      manage: "إدارة",
    },
    manage: {
      title: "الملفات الشخصية والسلاسل",
      noHosts: "لا يدعم أي مضيف متصل الملفات الشخصية. حدّث الخدمة الخلفية.",
      profiles: "الملفات الشخصية",
      profilesEmpty: "لا توجد ملفات شخصية بعد. تستخدم المكالمات الإعدادات الافتراضية للمضيف.",
      threads: "السلاسل",
      threadsEmpty: "لا توجد سلاسل بعد. كل مكالمة على هذا المضيف تبدأ واحدة.",
      selectedForCalls: "يُستخدم للمكالمات الجديدة",
      continuing: "ستكمله المكالمة التالية",
      hostDefault: "افتراضي المضيف",
      fromConfig: "من config.json الخاص بالخدمة",
    ...
    actions: {
      ...
      menu: "إجراءات {{name}}",
      useForCalls: "استخدام للمكالمات",
      stopUsing: "استخدام افتراضي المضيف",
      continueThread: "المتابعة في المكالمة التالية",
      stopContinuing: "البدء من جديد في المكالمة التالية",
      openHistory: "فتح السجل",
      edit: "تعديل",
      delete: "حذف",
      deleteProfileTitle: "حذف {{name}}؟",
      deleteProfileMessage: "تحتفظ السلاسل التي استخدمته بسجلها وتستمر دون إعداداته.",
      deleteThreadTitle: "حذف {{title}}؟",
      deleteThreadMessage: "سيُحذف سجل المحادثة والملخص. يستمر العمل المفوَّض إلى الوكلاء.",
    },
    form: {
      createTitle: "ملف شخصي جديد",
      editTitle: "تعديل الملف الشخصي",
      create: "إنشاء",
      save: "حفظ التغييرات",
      name: {
        label: "الاسم",
        placeholder: "رئيس الموظفين",
      },
      instructions: {
        label: "التعليمات",
        hint: "{{length}} / {{max}}. تُمرَّر إلى الوكيل الصوتي كما هي في كل مكالمة.",
        placeholder: "وجّه العمل إلى الوكلاء؛ لا تكتب الكود بنفسك أبدًا.",
      },
      context: {
        label: "السياق",
        hint: "{{length}} / {{max}}. خلفية تعرفها المكالمة منذ البداية.",
        placeholder: "نحن بصدد إطلاق مشروع الصوت. فضّل مستودع paseo.",
      },
      files: {
        label: "ملفات السياق",
        hint: "{{count}} / {{max}}. مسار مطلق واحد أو يبدأ بـ ~ في كل سطر؛ تقرأها الخدمة عند بدء المكالمة.",
        placeholder: "~/org/AGENTS.md",
      },
      voice: {
        label: "الصوت",
        hint: "يُستخدم للمكالمات الجديدة.",
        default: "افتراضي",
      },
      backendModel: {
        label: "نموذج الإجراءات",
        hint: "ينفّذ إجراءات المكالمة في الخلفية؛ وليس النموذج المتحدث.",
        default: "افتراضي (سريع)",
      },
      backendThinking: {
        label: "تفكير الإجراءات",
        hint: "عمق الاستدلال لنموذج الإجراءات.",
        default: "افتراضي",
      },
      errors: {
        nameRequired: "الاسم مطلوب",
        ...
        tooLong: "طويل جدًا",
        filesInvalid: "يجب أن يكون كل ملف مسارًا مطلقًا أو يبدأ بـ ~، بحد أقصى 16",
      },
    },
    history: {
      title: "السجل",
      empty: "لا شيء محفوظ بعد. ابدأ مكالمة للبدء.",
      loadOlder: "تحميل الأقدم",
      callStarted: "بدأت المكالمة",
      callEnded: "انتهت المكالمة · {{cause}}",
      delegationOk: "تم التفويض: {{description}}",
      delegationFailed: "فشل التفويض ({{code}}): {{description}}",
      user: "أنت",
      assistant: "المساعد",
      limits:
        "تبدأ المكالمات الجديدة من الملخص مع أحدث سجل يتسع ضمن حد السياق لدى المزوّد. لا يُستأنف الكلام المباشر.",
      summary: {
        label: "الملخص",
        hint: "تكتبه أنت. تقرأه المكالمات الجديدة بدلًا من السجل الأقدم.",
        coversThrough: "يغطي السجل حتى الإدخال رقم {{seq}}.",
        placeholder: "ما ينبغي أن تحمله المكالمة التالية.",
        willCover: "سيغطي الحفظ السجل حتى الإدخال رقم {{seq}}.",
        save: "حفظ الملخص",
      },
    },
  },
  ...
  contextWindow: {
    ...
    promptCache: {
      title: "ذاكرة التخزين المؤقت للمطالبات",
      statusWarm: "دافئة",
      statusExpiring: "على وشك الانتهاء",
      statusExpired: "منتهية على الأرجح",
      statusUnknown: "المدة غير معروفة",
      warmFor: "دافئة لمدة ~{{duration}}",
      expiredAgo: "انتهت منذ {{duration}}",
      lastRequestAgo: "آخر طلب منذ {{duration}}",
      durationSeconds: "{{value}} ثانية",
      durationMinutes: "{{value}} دقيقة",
      lastRequest: "آخر طلب {{percent}}% مخزّن · {{split}}",
      split: "{{cached}} مخزّن، {{fresh}} جديد",
      splitWithWrite: "{{cached}} مخزّن، {{fresh}} جديد، {{written}} مكتوب",
      sessionSingular: "الجلسة {{percent}}% مخزّنة عبر {{count}} طلب",
      sessionPlural: "الجلسة {{percent}}% مخزّنة عبر {{count}} طلبات",
      ping: "تنشيط",
      pinging: "جارٍ التنشيط...",
      pingHint: "يرسل رسالة قصيرة للحفاظ على دفء الذاكرة",
      pingError: "تعذّر إرسال التنشيط",
    },
  },
  review: {
    comment: {
  ...
  settings: {
    ...
    usageHistory: {
      sort: {
        ...
        moveUp: "نقل لأعلى",
        remove: "إزالة",
        timeHint: "تبدأ الأسابيع يوم الاثنين. تشمل الإجماليات النطاق الزمني المحدد فقط.",
      },
      ...
      refresh: "تحديث",
      unsupported: "حدّث المضيف لعرض سجل الاستخدام",
      hostUnavailable: "اتصل بمضيف لعرض سجل الاستخدام",
      clientUnavailable: "الاتصال بالمضيف غير جاهز",
      errorTitle: "تعذر تحميل سجل الاستخدام",
      empty: "لا يوجد نشاط في هذه الفترة",
      pricingUnavailable: "التكاليف غير متاحة حتى يتم تحميل أسعار النماذج",
      addHost: "أضف مضيفًا لعرض سجل الاستخدام",
      hostsUnavailable: "لا يمكن لأي مضيف محدد الإبلاغ عن سجل الاستخدام",
      hostFilter: {
        label: "المضيفون",
        all: "كل المضيفين",
        count_one: "مضيف {{count}}",
        count_other: "{{count}} مضيفين",
      },
      coverage: {
        scanning: "جارٍ فحص {{hosts}}…",
        offline_one: "{{hosts}} غير متصل",
        offline_other: "{{hosts}} غير متصلين",
        unsupported_one: "{{hosts}} يشغّل إصدارًا أقدم من Paseo وتم استبعاده",
      ...
      summary: {
        sessions_one: "جلسة {{count}}",
        sessions_other: "{{count}} جلسات",
      ...
      totals: {
        title: "الإجماليات",
        processedTokens: "الرموز المعالجة",
        cachedInput: "الإدخال المخزّن مؤقتًا",
        uncachedInput: "الإدخال غير المخزّن",
        output: "الإخراج",
    ...
    shortcuts: {
      ...
      help: {
        ...
        nextReadyWaitingWorkspace: "مساحة العمل التالية الجاهزة أو المنتظرة",
    ...
    host: {
      ...
      agentEnvironment: {
        sectionTitle: "بيئة الوكيل",
        sectionDescription: "تُنفّذ الأوامر في دليل الوكيل قبل بدء تشغيله، ويصبح مخرجها بيئة الوكيل.",
        add: "إضافة إعداد بيئة",
        addCustom: "أمر مخصص…",
        addCustomTitle: "إضافة أمر بيئة",
        editCommand: "تحرير الأمر",
        editCommandTitle: "تحرير أمر البيئة",
        remove: "إزالة",
        removeConfirmTitle: "إزالة إعداد البيئة؟",
        removeConfirmMessage: "إزالة «{{name}}»؟",
        moveUp: "تحريك لأعلى",
        moveDown: "تحريك لأسفل",
        emptyState: "لا شيء يُنفّذ قبل بدء الوكيل. أضف direnv أو أمرًا مخصصًا.",
        unknownPreset: "هذا المضيف لا يتعرف على هذا الإعداد المسبق",
        rowFormat: "يقرأ مخرج {{format}}",
        commandLabel: "الأمر",
        commandHint: "مفصول بمسافات. شغّل صدفة بشكل صريح إن احتجت إليها.",
        commandPlaceholder: "direnv export json",
        commandRequired: "الأمر مطلوب",
        formatLabel: "صيغة المخرج",
        formatJson: "فرق JSON",
        formatEnv0: "env -0",
        formatJsonHint: "كائن من «KEY»: «value»، حيث يزيل null المتغير.",
        formatEnv0Hint: "سجلات KEY=VALUE مفصولة بـ NUL. كل ما يُحذف يُزال.",
        timeoutLabel: "المهلة",
        timeoutHint: "عدد المليّات الثانية قبل التخلي عن الأمر. اتركه فارغًا لاستخدام افتراضي المضيف.",
        timeoutPlaceholder: "30000",
        timeoutInvalid: "يجب أن تكون المهلة عددًا صحيحًا موجبًا",
        saving: "جارٍ الحفظ...",
        save: "حفظ",
      },
      terminalProfiles: {
