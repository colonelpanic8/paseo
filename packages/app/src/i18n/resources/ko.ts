...
export const ko: TranslationResources = {
  ...
  composer: {
    ...
    stash: {
      ...
      stashedEvicted:
        "프롬프트를 보관했습니다 — 공간을 확보하기 위해 가장 오래된 보관 프롬프트를 버렸습니다",
      restored: "보관한 프롬프트를 복원했습니다",
      undo: "실행 취소",
      badgeAccessibilityLabel: "보관한 프롬프트: {{count}}개. 보관함 열기.",
      menuTitle: "보관한 프롬프트",
      menuEmpty: "아직 보관한 항목이 없습니다",
      attachmentsOnly_one: "첨부 파일 {{count}}개",
      attachmentsOnly_other: "첨부 파일 {{count}}개",
      deleteEntry: "보관한 프롬프트 삭제",
      otherProviders_one: "다른 제공자에 프롬프트 {{count}}개가 보관되어 있습니다",
      otherProviders_other: "다른 제공자에 프롬프트 {{count}}개가 보관되어 있습니다",
    },
    errors: {
  ...
  message: {
    ...
    actions: {
      ...
      forkFullHistory: "전체 기록",
      forkFullHistoryUnavailable: "이 제공자는 세션을 분기할 수 없습니다.",
      forkSummary: "요약",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        copyBranchName: "브랜치 이름 복사",
        rename: "워크스페이스 이름 변경",
        retitle: "AI로 제목 다시 짓기",
        pin: "상단에 고정",
        unpin: "고정 해제",
        snooze: "다시 알림",
        snoozeHour: "1시간 동안 다시 알림",
        snoozeEvening: "오늘 저녁까지 다시 알림",
        snoozeTomorrow: "내일까지 다시 알림",
        snoozeNextWeek: "다음 주까지 다시 알림",
        snoozeCustom: "사용자 지정 다시 알림…",
        wake: "깨우기",
        snoozedUntil: "{{time}}까지 다시 알림 ({{duration}})",
      ...
      toasts: {
        ...
        hostDisconnected: "호스트가 연결되어 있지 않습니다",
        snoozingWorkspace: "워크스페이스를 다시 알림으로 설정하는 중...",
        snoozedWorkspace: "워크스페이스를 다시 알림으로 설정했습니다",
        failedToSnoozeWorkspace: "워크스페이스를 다시 알림으로 설정하지 못했습니다",
        wakingWorkspace: "워크스페이스를 깨우는 중...",
        wokeWorkspace: "워크스페이스를 깨웠습니다",
        failedToWakeWorkspace: "워크스페이스를 깨우지 못했습니다",
        retitlingWorkspace: "새 제목을 생성하는 중...",
        retitledWorkspace: "워크스페이스 제목을 변경했습니다",
        failedToRetitleWorkspace: "워크스페이스 제목을 변경하지 못했습니다",
  ...
  liveVoice: {
    ...
    settings: {
      ...
      quickLaunch: {
        ...
        auto: "자동",
        profileLabel: "바로가기 프로필",
        profileHint:
          "해당 호스트에서 바로가기 통화에 응답하는 프로필입니다. 실시간 음성 메뉴와 같은 선택입니다.",
        hostDefault: "호스트 기본값",
      },
      dispatch: {
  ...
  contextWindow: {
    ...
    promptCache: {
      ...
      statusWarm: "유효함",
      statusExpiring: "곧 만료",
      statusExpired: "만료된 것으로 보임",
      statusUnknown: "유지 시간 알 수 없음",
      warmFor: "약 {{duration}} 남음",
      expiredAgo: "{{duration}} 전에 만료됨",
      lastRequestAgo: "마지막 요청 {{duration}} 전",
      durationSeconds: "{{value}}초",
      durationMinutes: "{{value}}분",
      lastRequest: "마지막 요청 {{percent}}% 캐시됨 · {{split}}",
      split: "캐시 {{cached}}, 신규 {{fresh}}",
      splitWithWrite: "캐시 {{cached}}, 신규 {{fresh}}, 기록 {{written}}",
      sessionSingular: "세션 {{percent}}% 캐시됨, 요청 {{count}}건",
      sessionPlural: "세션 {{percent}}% 캐시됨, 요청 {{count}}건",
      ping: "예열",
      pinging: "예열 중...",
      pingHint: "캐시를 유지하기 위해 짧은 메시지를 보냅니다",
      pingError: "메시지를 보낼 수 없습니다",
    },
  },
  review: {
    comment: {
  ...
  settings: {
    ...
    usageHistory: {
      sort: {
        ...
        moveUp: "위로 이동",
        remove: "제거",
        timeHint: "주는 월요일에 시작합니다. 합계에는 선택한 기간만 포함됩니다.",
      },
      ...
      refresh: "새로고침",
      unsupported: "사용 기록을 보려면 호스트를 업데이트하세요",
      hostUnavailable: "사용 기록을 보려면 호스트에 연결하세요",
      clientUnavailable: "호스트 연결이 준비되지 않았습니다",
      errorTitle: "사용 기록을 불러올 수 없습니다",
      empty: "이 기간에 활동이 없습니다",
      pricingUnavailable: "모델 가격이 로드될 때까지 비용을 사용할 수 없습니다",
      addHost: "사용 기록을 보려면 호스트를 추가하세요",
      hostsUnavailable: "선택한 호스트 중 사용 기록을 보고할 수 있는 호스트가 없습니다",
      hostFilter: {
        label: "호스트",
        all: "모든 호스트",
        count_one: "호스트 {{count}}개",
        count_other: "호스트 {{count}}개",
      },
      coverage: {
        scanning: "{{hosts}} 스캔 중…",
        offline_one: "{{hosts}}은(는) 오프라인 상태입니다",
        offline_other: "{{hosts}}은(는) 오프라인 상태입니다",
        unsupported_one: "{{hosts}}은(는) 이전 버전의 Paseo를 실행 중이라 제외되었습니다",
      ...
      summary: {
        sessions_one: "세션 {{count}}개",
        sessions_other: "세션 {{count}}개",
      ...
      totals: {
        title: "합계",
        processedTokens: "처리 토큰",
        cachedInput: "캐시된 입력",
        uncachedInput: "캐시되지 않은 입력",
        output: "출력",
        cacheSavings: "캐시 절감",
      },
      breakdown: {
    ...
    host: {
      ...
      agentEnvironment: {
        sectionTitle: "에이전트 환경",
        sectionDescription:
          "에이전트가 시작되기 전에 해당 디렉터리에서 명령을 실행합니다. 그 출력이 에이전트의 환경이 됩니다.",
        add: "환경 설정 추가",
        addCustom: "사용자 지정 명령…",
        addCustomTitle: "환경 명령 추가",
        editCommand: "명령 편집",
        editCommandTitle: "환경 명령 편집",
        remove: "제거",
        removeConfirmTitle: "환경 설정을 제거할까요?",
        removeConfirmMessage: '"{{name}}"을(를) 제거할까요?',
        moveUp: "위로 이동",
        moveDown: "아래로 이동",
        emptyState:
          "에이전트 시작 전에 실행되는 것이 없습니다. direnv 또는 사용자 지정 명령을 추가하세요.",
        unknownPreset: "이 호스트는 이 프리셋을 인식하지 못합니다",
        rowFormat: "{{format}} 출력을 읽습니다",
        commandLabel: "명령",
        commandHint: "공백으로 구분합니다. 셸이 필요하면 명시적으로 실행하세요.",
        commandPlaceholder: "direnv export json",
        commandRequired: "명령은 필수입니다",
        formatLabel: "출력 형식",
        formatJson: "JSON 차이",
        formatEnv0: "env -0",
        formatJsonHint: '"KEY": "value" 객체이며, null은 변수를 제거합니다.',
        formatEnv0Hint: "NUL로 구분된 KEY=VALUE 레코드입니다. 생략된 것은 제거됩니다.",
        timeoutLabel: "제한 시간",
        timeoutHint: "명령을 포기하기까지의 밀리초입니다. 비워두면 호스트 기본값을 사용합니다.",
        timeoutPlaceholder: "30000",
        timeoutInvalid: "제한 시간은 양의 정수여야 합니다",
        saving: "저장 중...",
        save: "저장",
      },
      terminalProfiles: {
