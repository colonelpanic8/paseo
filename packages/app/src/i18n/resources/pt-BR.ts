...
export const ptBR: TranslationResources = {
  ...
  settings: {
    ...
    providers: {
      ...
      accounts: {
        title: "Contas",
        updateHost: "Atualize o host para gerenciar contas de provedores.",
        addClaudeTitle: "Adicionar conta do Claude",
        addClaude: "Conta do Claude Code",
        addClaudeDescription: "Use um diretório de configuração do Claude separado",
        addCodexTitle: "Adicionar conta do Codex",
        addCodex: "Conta do Codex / ChatGPT",
        addCodexDescription: "Use um diretório Codex e login separados",
        add: "Adicionar conta",
        name: "Nome da conta",
        namePlaceholder: "ex.: Trabalho",
        claudeDirectory: "Diretório de configuração do Claude",
        claudeDirectoryPlaceholder: "/home/you/.claude-work",
        claudeDirectoryHint: "Defina CLAUDE_CONFIG_DIR como este caminho absoluto no host.",
        codexDirectory: "Diretório inicial do Codex",
        codexDirectoryPlaceholder: "/home/you/.codex-work",
        codexDirectoryHint: "Defina CODEX_HOME como este caminho absoluto no host.",
        errors: {
