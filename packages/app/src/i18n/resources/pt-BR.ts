...
export const ptBR: TranslationResources = {
  ...
  composer: {
    ...
    stash: {
      ...
      stashedEvicted: "Prompt guardado — o mais antigo foi descartado para abrir espaço",
      restored: "Prompt guardado restaurado",
      undo: "Desfazer",
      badgeAccessibilityLabel: "Prompts guardados: {{count}}. Abrir a reserva.",
      menuTitle: "Prompts guardados",
      menuEmpty: "Nada guardado ainda",
      attachmentsOnly_one: "{{count}} anexo",
      attachmentsOnly_other: "{{count}} anexos",
      deleteEntry: "Excluir prompt guardado",
      otherProviders_one: "{{count}} prompt guardado em outro provedor",
      otherProviders_other: "{{count}} prompts guardados em outros provedores",
    },
    errors: {
  ...
  message: {
    ...
    actions: {
      ...
      forkFullHistory: "Histórico completo",
      forkFullHistoryUnavailable: "Este provedor não pode ramificar a sessão.",
      forkSummary: "Resumo",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        retitle: "Renomear com IA",
        pin: "Fixar no topo",
        unpin: "Desafixar",
        snooze: "Adiar",
        snoozeHour: "Adiar por 1 hora",
        snoozeEvening: "Adiar até esta noite",
        snoozeTomorrow: "Adiar até amanhã",
        snoozeNextWeek: "Adiar até a próxima semana",
        snoozeCustom: "Adiar até um horário personalizado…",
        wake: "Reativar",
        snoozedUntil: "Adiado até {{time}} ({{duration}})",
      ...
      customSnooze: {
        ...
        date: "Data",
        time: "Hora",
        pastTime: "Escolha um horário futuro.",
        confirm: "Adiar",
      },
      toasts: {
        ...
        hostDisconnected: "Host não está conectado",
        snoozingWorkspace: "Adiando workspace...",
        snoozedWorkspace: "Workspace adiado",
        failedToSnoozeWorkspace: "Falha ao adiar workspace",
        wakingWorkspace: "Reativando workspace...",
        wokeWorkspace: "Workspace reativado",
        failedToWakeWorkspace: "Falha ao reativar workspace",
        retitlingWorkspace: "Gerando um novo título...",
        retitledWorkspace: "Workspace renomeado",
        failedToRetitleWorkspace: "Falha ao renomear o workspace",
  ...
  liveVoice: {
    ...
    settings: {
      ...
      quickLaunch: {
        ...
        auto: "Automático",
        profileLabel: "Perfil do atalho",
        profileHint:
          "Qual perfil atende uma chamada por atalho nesse host. A mesma seleção do menu de voz ao vivo.",
  ...
  contextWindow: {
    ...
    promptCache: {
      ...
      statusExpired: "Provavelmente expirado",
      statusUnknown: "Duração desconhecida",
      warmFor: "quente por ~{{duration}}",
      expiredAgo: "expirou há {{duration}}",
      lastRequestAgo: "última solicitação há {{duration}}",
      durationSeconds: "{{value}} s",
      durationMinutes: "{{value}} min",
      lastRequest: "Última solicitação {{percent}}% em cache · {{split}}",
      split: "{{cached}} em cache, {{fresh}} novos",
      splitWithWrite: "{{cached}} em cache, {{fresh}} novos, {{written}} gravados",
      sessionSingular: "Sessão {{percent}}% em cache em {{count}} solicitação",
      sessionPlural: "Sessão {{percent}}% em cache em {{count}} solicitações",
      ping: "Aquecer",
      pinging: "Aquecendo...",
      pingHint: "Envia uma mensagem curta para manter o cache quente",
      pingError: "Não foi possível enviar a mensagem",
    },
  },
  review: {
    comment: {
  ...
  intents: {
    ...
    links: {
      unknownHost: "Nenhum host chamado {{serverId}} está configurado neste dispositivo.",
      noHosts: "Adicione um host antes de abrir links do Paseo.",
      ambiguousHost: "Há vários hosts configurados. Adicione serverId ao link.",
      missingAgent: "O link não indica um agente.",
      missingWorkspace: "O link não indica um espaço de trabalho.",
      promptSent: "Prompt enviado.",
      sendDisabled:
        "Prompt adicionado ao compositor. Ative “Enviar prompts de links” em Configurações para enviá-lo sem confirmação.",
  ...
  settings: {
    ...
    usageHistory: {
      ...
      info: "Totais de tokens e custo lidos das transcrições de sessão das CLIs dos provedores em cada host conectado. Os custos são estimativas equivalentes à API, não uma fatura.",
      refresh: "Atualizar",
      unsupported: "Atualize o host para ver o histórico de uso",
      hostUnavailable: "Conecte-se a um host para ver o histórico de uso",
      clientUnavailable: "A conexão com o host não está pronta",
      errorTitle: "Não foi possível carregar o histórico de uso",
      empty: "Sem atividade neste período",
      pricingUnavailable: "Os custos ficam indisponíveis até os preços dos modelos carregarem",
      addHost: "Adicione um host para ver o histórico de uso",
      hostsUnavailable: "Nenhum host selecionado pode informar o histórico de uso",
      hostFilter: {
        label: "Hosts",
        all: "Todos os hosts",
      ...
      coverage: {
        scanning: "Verificando {{hosts}}…",
        offline_one: "{{hosts}} está offline",
        offline_other: "{{hosts}} estão offline",
        unsupported_one: "{{hosts}} usa uma versão antiga do Paseo e ficou de fora",
        unsupported_other: "{{hosts}} usam uma versão antiga do Paseo e ficaram de fora",
        failed_one: "{{hosts}} não conseguiu ler as transcrições",
        failed_other: "{{hosts}} não conseguiram ler as transcrições",
        duplicates: "Contado uma vez: {{groups}}",
        duplicateGroup_one: "{{hosts}} lê as mesmas transcrições que {{claimedBy}}",
        duplicateGroup_other: "{{hosts}} leem as mesmas transcrições que {{claimedBy}}",
      },
      metric: {
        cost: "Custo",
        tokens: "Tokens",
      ...
      totals: {
        title: "Totais",
        processedTokens: "Tokens processados",
        cachedInput: "Entrada em cache",
        uncachedInput: "Entrada sem cache",
        output: "Saída",
    ...
    general: {
      ...
      modelPickerAllModels: {
        label: "Abrir o seletor de modelos em todos os modelos",
        description:
          "Iniciar o seletor de modelos em uma única lista pesquisável com todos os modelos de todos os provedores, em vez da lista de provedores",
      },
      toolCallDetail: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        nextReadyWaitingWorkspace: "Próximo workspace pronto ou aguardando",
    ...
    host: {
      ...
      agentEnvironment: {
        sectionTitle: "Ambiente do agente",
        sectionDescription:
          "Os comandos rodam no diretório de um agente antes de ele iniciar. A saída deles vira o ambiente do agente.",
        add: "Adicionar configuração de ambiente",
        addCustom: "Comando personalizado…",
        addCustomTitle: "Adicionar comando de ambiente",
        editCommand: "Editar comando",
        editCommandTitle: "Editar comando de ambiente",
        remove: "Remover",
        removeConfirmTitle: "Remover a configuração de ambiente?",
        removeConfirmMessage: 'Remover "{{name}}"?',
        moveUp: "Mover para cima",
        moveDown: "Mover para baixo",
        emptyState:
          "Nada roda antes de um agente iniciar. Adicione direnv ou um comando personalizado.",
        unknownPreset: "Este host não reconhece esta predefinição",
        rowFormat: "Lê saída {{format}}",
        commandLabel: "Comando",
        commandHint: "Separado por espaços. Execute um shell explicitamente se precisar.",
        commandPlaceholder: "direnv export json",
        commandRequired: "O comando é obrigatório",
        formatLabel: "Formato de saída",
        formatJson: "Diferença JSON",
        formatEnv0: "env -0",
        formatJsonHint: 'Um objeto de "CHAVE": "valor", onde null remove a variável.',
        formatEnv0Hint: "Registros CHAVE=VALOR separados por NUL. Tudo omitido é removido.",
        timeoutLabel: "Tempo limite",
        timeoutHint:
          "Milissegundos antes de desistir do comando. Deixe em branco para usar o padrão do host.",
        timeoutPlaceholder: "30000",
        timeoutInvalid: "O tempo limite deve ser um número inteiro positivo",
        saving: "Salvando...",
        save: "Salvar",
      },
      terminalProfiles: {
