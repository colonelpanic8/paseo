...
export const es: TranslationResources = {
  ...
  settings: {
    ...
    providers: {
      ...
      accounts: {
        title: "Cuentas",
        updateHost: "Actualiza el host para gestionar cuentas de proveedores.",
        addClaudeTitle: "Añadir cuenta de Claude",
        addClaude: "Cuenta de Claude Code",
        addClaudeDescription: "Usa un directorio de configuración de Claude separado",
        addCodexTitle: "Añadir cuenta de Codex",
        addCodex: "Cuenta de Codex / ChatGPT",
        addCodexDescription: "Usa un directorio de Codex y un inicio de sesión separados",
        add: "Añadir cuenta",
        name: "Nombre de la cuenta",
        namePlaceholder: "p. ej., Trabajo",
        claudeDirectory: "Directorio de configuración de Claude",
        claudeDirectoryPlaceholder: "/home/you/.claude-work",
        claudeDirectoryHint: "Asigna a CLAUDE_CONFIG_DIR esta ruta absoluta en el host.",
        codexDirectory: "Directorio principal de Codex",
        codexDirectoryPlaceholder: "/home/you/.codex-work",
        codexDirectoryHint: "Asigna a CODEX_HOME esta ruta absoluta en el host.",
        errors: {
