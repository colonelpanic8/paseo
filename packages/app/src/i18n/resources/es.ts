...
export const es: TranslationResources = {
  ...
  composer: {
    ...
    stash: {
      ...
      stashedEvicted: "Prompt guardado: el más antiguo se descartó para hacer espacio",
      restored: "Prompt guardado restaurado",
      undo: "Deshacer",
      badgeAccessibilityLabel: "Prompts guardados: {{count}}. Abrir la reserva.",
      menuTitle: "Prompts guardados",
      menuEmpty: "Aún no hay nada guardado",
      attachmentsOnly_one: "{{count}} adjunto",
      attachmentsOnly_other: "{{count}} adjuntos",
      deleteEntry: "Eliminar prompt guardado",
      otherProviders_one: "{{count}} prompt guardado con otro proveedor",
      otherProviders_other: "{{count}} prompts guardados con otros proveedores",
    },
    errors: {
  ...
  message: {
    ...
    actions: {
      ...
      forkFullHistory: "Historial completo",
      forkFullHistoryUnavailable: "Este proveedor no puede ramificar su sesión.",
      forkSummary: "Resumen",
  ...
  workspace: {
    ...
    tabs: {
      ...
      toasts: {
        ...
        copyingConversation: "Copiando conversación...",
        conversationCopiedLabel: "Conversación",
        conversationEmpty: "Esta conversación no tiene mensajes para copiar",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        retitle: "Renombrar con IA",
        pin: "Anclar arriba",
        unpin: "Desanclar",
        snooze: "Posponer",
        snoozeHour: "Posponer durante 1 hora",
        snoozeEvening: "Posponer hasta esta tarde",
        snoozeTomorrow: "Posponer hasta mañana",
        snoozeNextWeek: "Posponer hasta la próxima semana",
        snoozeCustom: "Posponer hasta una hora personalizada…",
        wake: "Reactivar",
        snoozedUntil: "Pospuesto hasta {{time}} ({{duration}})",
        snoozedChip: "{{time}} · {{duration}}",
        archive: "Archivo",
      ...
      customSnooze: {
        title: "Posponer hasta una hora personalizada",
        until: "Posponer hasta",
        date: "Fecha",
        time: "Hora",
        pastTime: "Elige una hora futura.",
        confirm: "Posponer",
      },
      toasts: {
        ...
        hostDisconnected: "Hostno está conectado",
        snoozingWorkspace: "Posponiendo espacio de trabajo...",
        snoozedWorkspace: "Espacio de trabajo pospuesto",
        failedToSnoozeWorkspace: "No se pudo posponer el espacio de trabajo",
        wakingWorkspace: "Reactivando espacio de trabajo...",
        wokeWorkspace: "Espacio de trabajo reactivado",
        failedToWakeWorkspace: "No se pudo reactivar el espacio de trabajo",
        retitlingWorkspace: "Generando un nuevo título...",
        retitledWorkspace: "Workspace renombrado",
        failedToRetitleWorkspace: "No se pudo renombrar el workspace",
  ...
  voiceProfiles: {
    menu: {
      profileLabel: "Perfil",
      defaultProfile: "Predeterminado del host",
      threadLabel: "Hilo",
      newThread: "Nuevo hilo",
      manage: "Gestionar perfiles…",
    },
    thread: {
      untitled: "Hilo sin título",
    },
    settings: {
      title: "Perfiles e hilos",
      description:
        "Un perfil define cómo se comporta una llamada: instrucciones, contexto, archivos, voz y modelo de acción. Un hilo es lo que una llamada recuerda. Cada llamada abre o continúa un hilo bajo el perfil elegido.",
      manage: "Gestionar",
    },
    manage: {
      title: "Perfiles e hilos",
      noHosts: "Ningún host conectado admite perfiles. Actualiza su daemon.",
      profiles: "Perfiles",
      profilesEmpty:
        "Aún no hay perfiles. Las llamadas usan la configuración predeterminada del host.",
      threads: "Hilos",
      threadsEmpty: "Aún no hay hilos. Cada llamada en este host inicia uno.",
      selectedForCalls: "Usado en nuevas llamadas",
      continuing: "La próxima llamada lo continúa",
      hostDefault: "Predeterminado del host",
      fromConfig: "Del config.json del daemon",
    ...
    actions: {
      ...
      stopUsing: "Usar el predeterminado del host",
      continueThread: "Continuar en la próxima llamada",
      stopContinuing: "Empezar de cero en la próxima llamada",
      openHistory: "Abrir historial",
      edit: "Editar",
      delete: "Eliminar",
      deleteProfileTitle: "¿Eliminar {{name}}?",
      deleteProfileMessage:
        "Los hilos que lo usaban conservan su historial y continúan sin su configuración.",
    ...
    form: {
      ...
      context: {
        label: "Contexto",
        hint: "{{length}} / {{max}}. Antecedentes que la llamada conoce desde el inicio.",
        placeholder: "Estamos lanzando el proyecto de voz. Prefiere el repositorio paseo.",
      },
      files: {
        label: "Archivos de contexto",
        hint: "{{count}} / {{max}}. Una ruta absoluta o con ~ por línea; el daemon las lee al iniciar la llamada.",
        placeholder: "~/org/AGENTS.md",
      },
      voice: {
        label: "Voz",
        hint: "Se usa en nuevas llamadas.",
        default: "Predeterminada",
      },
      backendModel: {
        label: "Modelo de acción",
        hint: "Ejecuta las acciones de la llamada en segundo plano; no es el modelo que habla.",
        default: "Predeterminado (rápido)",
      },
      backendThinking: {
        label: "Razonamiento de acción",
        hint: "Profundidad de razonamiento del modelo de acción.",
        default: "Predeterminado",
      },
      errors: {
        nameRequired: "El nombre es obligatorio",
        ...
        filesInvalid: "Cada archivo debe ser una ruta absoluta o con ~, como máximo 16",
      },
    },
    history: {
      title: "Historial",
      ...
      delegationFailed: "Delegación fallida ({{code}}): {{description}}",
      user: "Tú",
      assistant: "Asistente",
      limits:
        "Las nuevas llamadas parten del resumen más el historial reciente que quepa en el límite de contexto del proveedor. El habla en vivo no se reanuda.",
      summary: {
        label: "Resumen",
        hint: "Escrito por ti. Las nuevas llamadas lo leen en lugar del historial antiguo.",
        coversThrough: "Cubre el historial hasta la entrada #{{seq}}.",
        placeholder: "Lo que la próxima llamada debe tener presente.",
        willCover: "Al guardar se cubre el historial hasta la entrada #{{seq}}.",
  ...
  contextWindow: {
    ...
    promptCache: {
      ...
      statusWarm: "Caliente",
      statusExpiring: "Expira pronto",
      statusExpired: "Probablemente expirada",
      statusUnknown: "Duración desconocida",
      warmFor: "caliente durante ~{{duration}}",
      expiredAgo: "expiró hace {{duration}}",
      lastRequestAgo: "última solicitud hace {{duration}}",
      durationSeconds: "{{value}} s",
      durationMinutes: "{{value}} min",
      lastRequest: "Última solicitud {{percent}}% en caché · {{split}}",
      split: "{{cached}} en caché, {{fresh}} nuevos",
      splitWithWrite: "{{cached}} en caché, {{fresh}} nuevos, {{written}} escritos",
      sessionSingular: "Sesión {{percent}}% en caché en {{count}} solicitud",
      sessionPlural: "Sesión {{percent}}% en caché en {{count}} solicitudes",
      ping: "Calentar",
      pinging: "Calentando...",
      pingHint: "Envía un mensaje corto para mantener la caché caliente",
      pingError: "No se pudo enviar el mensaje",
    },
  },
  review: {
    comment: {
  ...
  settings: {
    ...
    usageHistory: {
      ...
      refresh: "Actualizar",
      unsupported: "Actualiza el host para ver el historial de uso",
      hostUnavailable: "Conecta un host para ver el historial de uso",
      clientUnavailable: "La conexión con el host no está lista",
      errorTitle: "No se pudo cargar el historial de uso",
      empty: "Sin actividad en este período",
      pricingUnavailable:
        "Los costos no están disponibles hasta que se carguen los precios de los modelos",
      addHost: "Añade un host para ver el historial de uso",
      hostsUnavailable: "Ningún host seleccionado puede informar del historial de uso",
      hostFilter: {
        label: "Hosts",
        all: "Todos los hosts",
      ...
      coverage: {
        scanning: "Analizando {{hosts}}…",
        offline_one: "{{hosts}} está desconectado",
        offline_other: "{{hosts}} están desconectados",
        unsupported_one: "{{hosts}} usa una versión antigua de Paseo y queda excluido",
      ...
      totals: {
        title: "Totales",
        processedTokens: "Tokens procesados",
    ...
    shortcuts: {
      ...
      help: {
        ...
        nextReadyWaitingWorkspace: "Siguiente espacio de trabajo listo o en espera",
    ...
    host: {
      ...
      agentEnvironment: {
        sectionTitle: "Entorno del agente",
        sectionDescription:
          "Los comandos se ejecutan en el directorio de un agente antes de iniciarlo. Su salida se convierte en el entorno del agente.",
        add: "Añadir configuración de entorno",
        addCustom: "Comando personalizado…",
        addCustomTitle: "Añadir comando de entorno",
        editCommand: "Editar comando",
        editCommandTitle: "Editar comando de entorno",
        remove: "Eliminar",
        removeConfirmTitle: "¿Eliminar la configuración de entorno?",
        removeConfirmMessage: '¿Eliminar "{{name}}"?',
        moveUp: "Mover arriba",
        moveDown: "Mover abajo",
        emptyState:
          "No se ejecuta nada antes de iniciar un agente. Añade direnv o un comando personalizado.",
        unknownPreset: "Este host no reconoce este preajuste",
        rowFormat: "Lee salida {{format}}",
        commandLabel: "Comando",
        commandHint: "Separado por espacios. Ejecuta un shell explícitamente si lo necesitas.",
        commandPlaceholder: "direnv export json",
        commandRequired: "El comando es obligatorio",
        formatLabel: "Formato de salida",
        formatJson: "Diferencia JSON",
        formatEnv0: "env -0",
        formatJsonHint: 'Un objeto de "CLAVE": "valor", donde null elimina la variable.',
        formatEnv0Hint: "Registros CLAVE=VALOR separados por NUL. Todo lo omitido se elimina.",
        timeoutLabel: "Tiempo de espera",
        timeoutHint:
          "Milisegundos antes de abandonar el comando. Déjalo vacío para usar el valor predeterminado del host.",
        timeoutPlaceholder: "30000",
        timeoutInvalid: "El tiempo de espera debe ser un número entero positivo",
        saving: "Guardando...",
        save: "Guardar",
      },
      terminalProfiles: {
