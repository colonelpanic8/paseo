  ...
  workspace: {
    ...
    tabs: {
      ...
      toasts: {
        ...
        snoozingAgent: "Posponiendo agente...",
        snoozedAgent: "Agente pospuesto",
        failedToSnoozeAgent: "No se pudo posponer el agente",
        wakingAgent: "Reactivando agente...",
        wokeAgent: "Agente reactivado",
        failedToWakeAgent: "No se pudo reactivar el agente",
      },
      confirmations: {
