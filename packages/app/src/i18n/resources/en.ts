export const en = {
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        retitle: "Retitle with AI",
        pin: "Pin to top",
        unpin: "Unpin",
        snooze: "Snooze",
        snoozeHour: "Snooze for 1 hour",
        snoozeEvening: "Snooze until this evening",
        snoozeTomorrow: "Snooze until tomorrow",
        snoozeNextWeek: "Snooze until next week",
        snoozeCustom: "Custom snooze…",
        wake: "Wake",
        snoozedUntil: "Snoozed until {{time}} ({{duration}})",
      ...
      customSnooze: {
        ...
        date: "Date",
        time: "Time",
        pastTime: "Choose a time in the future.",
        confirm: "Snooze",
      },
      toasts: {
        ...
        hostDisconnected: "Host is not connected",
        snoozingWorkspace: "Snoozing workspace...",
        snoozedWorkspace: "Workspace snoozed",
        failedToSnoozeWorkspace: "Failed to snooze workspace",
        wakingWorkspace: "Waking workspace...",
        wokeWorkspace: "Workspace awake",
        failedToWakeWorkspace: "Failed to wake workspace",
        retitlingWorkspace: "Generating a new title...",
        retitledWorkspace: "Workspace retitled",
        failedToRetitleWorkspace: "Failed to retitle workspace",
  ...
  voiceProfiles: {
    ...
    settings: {
      title: "Profiles and threads",
      description:
        "A profile is how a call behaves: instructions, context, files, voice, and action model. A thread is what a call remembers. Every call opens or continues a thread under the chosen profile.",
      manage: "Manage",
    },
    manage: {
      title: "Profiles and threads",
      noHosts: "No connected host supports profiles. Update its daemon.",
      profiles: "Profiles",
      profilesEmpty: "No profiles yet. Calls use the host's default settings.",
      threads: "Threads",
      threadsEmpty: "No threads yet. Every call on this host starts one.",
      selectedForCalls: "Used for new calls",
      continuing: "Continued by the next call",
      hostDefault: "Host default",
      fromConfig: "From the daemon's config.json",
    ...
    actions: {
      ...
      stopUsing: "Use host default",
      continueThread: "Continue in next call",
      stopContinuing: "Start fresh next call",
      openHistory: "Open history",
      edit: "Edit",
      delete: "Delete",
      deleteProfileTitle: "Delete {{name}}?",
      deleteProfileMessage:
        "Threads that used it keep their history and continue without its configuration.",
    ...
    form: {
      ...
      context: {
        label: "Context",
        hint: "{{length}} / {{max}}. Standing background the call knows from the start.",
        placeholder: "We are shipping the voice project. Prefer the paseo repo.",
      },
      files: {
        label: "Context files",
        hint: "{{count}} / {{max}}. One absolute or ~-rooted path per line; the daemon reads them at call start.",
      ...
      backendModel: {
        label: "Action model",
        hint: "Runs the call's actions behind the scenes; not the speaking model.",
        default: "Default (fast)",
      },
      backendThinking: {
        label: "Action thinking",
      ...
      errors: {
        ...
        tooLong: "Too long",
        filesInvalid: "Each file must be an absolute or ~-rooted path, at most 16 of them",
      },
    },
    history: {
      title: "History",
      ...
      summary: {
        ...
        placeholder: "What the next call should carry forward.",
  ...
  settings: {
    ...
    usageHistory: {
      sort: {
        ...
        moveUp: "Move up",
        remove: "Remove",
        timeHint: "Weeks start on Monday. Totals include only the selected date range.",
      },
      ...
      refresh: "Refresh",
      unsupported: "Update the host to see usage history",
      hostUnavailable: "Connect a host to see usage history",
      clientUnavailable: "Host connection is not ready",
      errorTitle: "Unable to load usage history",
      empty: "No activity in this window",
      pricingUnavailable: "Costs are unavailable until model prices load",
      addHost: "Add a host to see usage history",
      hostsUnavailable: "No selected host can report usage history",
      hostFilter: {
        label: "Hosts",
        all: "All hosts",
      ...
      coverage: {
        scanning: "Scanning {{hosts}}…",
        offline_one: "{{hosts}} is offline",
        offline_other: "{{hosts}} are offline",
        unsupported_one: "{{hosts}} runs an older Paseo and is excluded",
