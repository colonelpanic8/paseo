export const en = {
  ...
  settings: {
    ...
    providers: {
      ...
      accounts: {
        title: "Accounts",
        updateHost: "Update the host to manage provider accounts.",
        addClaudeTitle: "Add Claude account",
        addClaude: "Claude Code account",
        addClaudeDescription: "Use a separate Claude configuration directory",
        addCodexTitle: "Add Codex account",
        addCodex: "Codex / ChatGPT account",
        addCodexDescription: "Use a separate Codex home and ChatGPT or API sign-in",
        add: "Add account",
        name: "Account name",
        namePlaceholder: "e.g. Work",
        claudeDirectory: "Claude configuration directory",
        claudeDirectoryPlaceholder: "/home/you/.claude-work",
        claudeDirectoryHint: "Set CLAUDE_CONFIG_DIR to this absolute path on the host.",
        codexDirectory: "Codex home directory",
        codexDirectoryPlaceholder: "/home/you/.codex-work",
        codexDirectoryHint: "Set CODEX_HOME to this absolute path on the host.",
        errors: {
