  ...
  workspace: {
    ...
    tabs: {
      ...
      toasts: {
        ...
        snoozingAgent: "Snoozing agent...",
        snoozedAgent: "Agent snoozed",
        failedToSnoozeAgent: "Failed to snooze agent",
        wakingAgent: "Waking agent...",
        wokeAgent: "Agent awake",
        failedToWakeAgent: "Failed to wake agent",
      },
      confirmations: {
        close: "Close",
        cancel: "Cancel",
