...
## T3 Code native terminal integration

This module is adapted from T3 Code's native mobile terminal module.

- Project: https://github.com/pingdotgg/t3code
- Source module: `apps/mobile/modules/t3-terminal`
- License: MIT

Copyright and license notices from T3 Code remain applicable to the adapted portions.

## Ghostty / libghostty

The iOS terminal renderer vendors `GhosttyKit.xcframework`, a libghostty build produced from T3
Code's iOS 16 support fork. That fork was created from VVTerm's custom-I/O Ghostty fork.
