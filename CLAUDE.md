...
| [docs/composer-tokens.md](docs/composer-tokens.md)                 | Command/skill pills — tokens as a view over plain text, configurable sigils, the web mirror's advance-width invariant          |
