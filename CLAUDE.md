...
| [docs/usage-history.md](docs/usage-history.md)                       | Usage history page — transcript sources per provider, counting rules that are easy to break, the per-file scan cache           |
| [docs/service-proxy.md](docs/service-proxy.md)                       | Service proxy: exposing workspace scripts at public URLs, DNS setup, reverse proxy config                                      |
| [docs/managed-hosts.md](docs/managed-hosts.md)                       | Desktop managed-host registry files, automatic direct enrollment, retries, and secret-storage boundary                         |
...
| [docs/android-intents.md](docs/android-intents.md)                   | Share sheet, text selection, `paseo://` automation links, launcher shortcuts, and the rules they follow                        |
...
| [docs/push-notifications.md](docs/push-notifications.md)             | Push pipeline — presence policy, Expo token lease, why F-Droid builds get nothing, ntfy channel                                |
